...
| after_all                |      no       | yes(need-revisit) |        no         |        yes        |     no      |
| all_gather               |      no       | yes(need-revisit) |        no         |        no         |     no      |
| all_reduce               |      no       | yes(need-revisit) | yes(need-revisit) |        no         |     no      |
...
| compute_reshape_shape    |      no       | yes(need-revisit) |        no         |        yes        |     no      |
| concatenate              |      yes      |        yes        |        yes        |        yes        |     no      |
| constant                 |      yes      |        yes        |        yes        |        yes        |     yes     |
| convert                  |      no       |        yes*       |    infeasible     |        yes        |     no      |
| convolution              |      no       | yes(need-revisit) |        no         | yes(need-revisit) |     no      |
| cosine                   |      yes      |        yes        |        yes        |        yes        |     yes     |
| create_token             |      no       | yes(need-revisit) |        no         |        yes        |     no      |
| cross-replica-sum        |      no       |        yes*       |       yes*        |        no         |     no      |
| cstr_reshapable          |      no       | yes(need-revisit) |        no         |        yes        |     no      |
| custom_call              |      no       |        yes*       |    infeasible     |        yes        |     no      |
| divide                   |      yes      |        yes        |        yes        |        yes        |     no      |
| dot                      |      no       | yes(need-revisit) | yes(need-revisit) |        yes        |     no      |
| dot_general              |      no       |        yes*       |       yes*        |        no         |     no      |
| dynamic_broadcast_in_dim |      no       | yes(need-revisit) |        no         |        no         |     no      |
| dynamic_conv             |      no       | yes(need-revisit) |        no         |        no         |     no      |
| dynamic_gather           |      no       | yes(need-revisit) | yes(need-revisit) |        no         |     no      |
| dynamic_iota             |      no       | yes(need-revisit) |        no         |        yes        |     no      |
| dynamic_pad              |      no       | yes(need-revisit) |        no         |        yes        |     no      |
| dynamic_reshape          |      no       | yes(need-revisit) |        no         |        yes        |     no      |
| dynamic_slice            |      no       |        yes*       |       yes*        |        no         |     no      |
| dynamic_update_slice     |      no       | yes(need-revisit) |        no         |        yes        |     no      |
| einsum                   |      no       | yes(need-revisit) |        no         |        no         |     no      |
...
| get_dimension_size       |      no       | yes(need-revisit) |        no         |        yes        |     no      |
| get_tuple_element        |      no       | yes(need-revisit) | yes(need-revisit) |        yes        |     no      |
| if                       |      no       |        yes*       |       yes*        |        no         |     no      |
| imag                     |      no       |        yes*       |       yes*        |        yes        |     no      |
| infeed                   |      no       | yes(need-revisit) |        no         |        no         |     no      |
...
| map                      |      no       | yes(need-revisit) |        no         |        no         |     no      |
...
| optimization_barrier     |      no       | yes(need-revisit) |        no         |        yes        |     no      |
| or                       |      yes      |        yes        |        yes        |        yes        |     yes     |
| outfeed                  |      no       | yes(need-revisit) |        no         |        no         |     no      |
| pad                      |      yes      |        yes        |        yes        |        no         |     no      |
| popcnt                   |      no       |        yes*       |       yes*        |        yes        |     no      |
| power                    |      no       |        yes*       |       yes*        |        yes        |     no      |
| real_dynamic_slice       |      no       | yes(need-revisit) |        no         |        yes        |     no      |
| real                     |      no       |        yes*       |       yes*        |        yes        |     no      |
| recv                     |      no       | yes(need-revisit) |        no         |        no         |     no      |
| reduce                   |      no       |        yes*       |       yes*        | yes(need-revisit) |     no      |
| reduce_precision         |      no       |        yes*       |       yes*        |        yes        |     no      |
| reduce_scatter           |      no       | yes(need-revisit) |        no         |        no         |     no      |
| reduce_window            |      no       |        yes*       |       yes*        |        no         |     no      |
| remainder                |      yes      |        yes        |        yes        |        yes        |     no      |
| replica_id               |      no       | yes(need-revisit) | yes(need-revisit) |        yes        |     no      |
| reshape                  |      yes      |        yes        |    infeasible     |        yes        |     yes     |
| return                   |      no       | yes(need-revisit) |        no         |        yes        |     no      |
...
| scatter                  |      no       | yes(need-revisit) |        no         |        no         |     no      |
| select                   |      no       |        yes*       |       yes*        |        yes        |     no      |
| select_and_scatter       |      no       | yes(need-revisit) |        no         |        no         |     no      |
| send                     |      no       | yes(need-revisit) |        no         |        no         |     no      |
| set_dimension_size       |      no       | yes(need-revisit) | yes(need-revisit) |        yes        |     no      |
...
| torch_index_select       |      no       | yes(need-revisit) |        no         |        no         |     no      |
| trace                    |      no       | yes(need-revisit) |        no         |        yes        |     no      |
| transpose                |      yes      |        yes        |        yes        |        no         |     yes     |
| triangular_solve         |      no       | yes(need-revisit) |        no         |        no         |     no      |
| tuple                    |      no       | yes(need-revisit) | yes(need-revisit) |        yes        |     no      |
| unary_einsum             |      no       | yes(need-revisit) |        no         |        no         |     no      |
