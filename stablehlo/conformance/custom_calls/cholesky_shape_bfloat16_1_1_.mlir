module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %13 = stablehlo.broadcast_in_dim %12, dims = [] : (tensor<f32>) -> tensor<1x1xf32>
    %14 = stablehlo.select %11, %6, %13 : tensor<1x1xi1>, tensor<1x1xf32>
    %15 = stablehlo.custom_call @check.eq(%14, %1) : (tensor<1x1xf32>, tensor<1x1xf32>) -> tensor<i1>
    return %15 : tensor<i1>
  }
  func.func private @inputs() -> tensor<1x1xf32> {
    %0 = stablehlo.constant dense<36.7539063> : tensor<1x1xf32>
    return %0 : tensor<1x1xf32>
  }
  func.func private @expected() -> tensor<1x1xf32> {
    %0 = stablehlo.constant dense<6.062500e+00> : tensor<1x1xf32>
    return %0 : tensor<1x1xf32>
  }
}
