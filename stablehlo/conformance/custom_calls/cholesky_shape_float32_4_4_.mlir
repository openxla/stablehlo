module @jit_testcase {
  ...
  func.func private @inputs() -> tensor<4x4xf32> {
    %0 = stablehlo.constant dense<[[53.0037689, -5.60876274, -35.4518509, -9.2876625], [-5.60876274, 32.1194878, 16.7143841, -16.6520977], [-35.4518509, 16.7143841, 31.939888, 1.49691391], [-9.2876625, -16.6520977, 1.49691391, 23.0243244]]> : tensor<4x4xf32>
    return %0 : tensor<4x4xf32>
  }
  func.func private @expected() -> tensor<4x4xf32> {
    %0 = stablehlo.constant dense<[[7.2803688, -5.60876274, -35.4518509, -9.2876625], [-0.770395457, 5.614800e+00, 16.7143841, -16.6520977], [-4.86951303, 2.30870795, 1.70223331, 1.49691391], [-1.27571321, -3.14078879, 1.48979342, 3.05169487]]> : tensor<4x4xf32>
    return %0 : tensor<4x4xf32>
  }
}
