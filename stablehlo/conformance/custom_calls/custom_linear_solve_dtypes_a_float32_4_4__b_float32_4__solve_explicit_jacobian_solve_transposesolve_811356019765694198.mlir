module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<4x4xf32>, tensor<4xf32>) {
    %0 = stablehlo.constant dense<[[0.139283285, 1.62023091, 2.87951469, 8.06196403], [0.555236399, -1.03784728, -2.73626828, -0.751573264], [1.02310324, 0.386334449, 3.72126555, -2.04775047], [-5.62063694, 2.86172867, 0.920292198, 0.750333071]]> : tensor<4x4xf32>
    %1 = stablehlo.constant dense<[4.63007784, -1.84508324, 0.76487571, -3.30199361]> : tensor<4xf32>
    return %0, %1 : tensor<4x4xf32>, tensor<4xf32>
  }
  func.func private @expected() -> tensor<4xf32> {
    %0 = stablehlo.constant dense<[-6.30529499, -15.6190176, 4.73356581, 2.13153291]> : tensor<4xf32>
