module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<4x4xf32>, tensor<4xf32>) {
    %0 = stablehlo.constant dense<[[-5.09132719, 4.99438858, -5.81634331, 0.0400977135], [4.99438858, -4.93593884, 1.42654693, 6.76106548], [-5.81634331, 1.42654693, -6.66966391, -5.85354471], [0.0400977135, 6.76106548, -5.85354471, -1.89497554]]> : tensor<4x4xf32>
    %1 = stablehlo.constant dense<[-1.44799304, -3.4156425, 3.38452315, 1.08657444]> : tensor<4xf32>
    return %0, %1 : tensor<4x4xf32>, tensor<4xf32>
  }
  func.func private @expected() -> tensor<4xf32> {
    %0 = stablehlo.constant dense<[0.248666152, -0.125091732, -0.0813914611, -0.763032793]> : tensor<4xf32>
