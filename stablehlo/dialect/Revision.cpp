...
// Generated at build time. Defines STABLEHLO_REVISION when a revision was
// embedded, and undefines it otherwise (CMake with STABLEHLO_APPEND_VC_REV=OFF,
// or any Bazel build).
#include "stablehlo/dialect/StablehloRevision.h"
