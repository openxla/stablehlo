...
#ifndef STABLEHLO_REFERENCE_STABLEHLOVALUE_H
#define STABLEHLO_REFERENCE_STABLEHLOVALUE_H
...
class StablehloValue {
 public:
  /// \name Constructors
  /// @{
  StablehloValue() = default;
  StablehloValue(const Tensor &tensor);
  StablehloValue(const Token &token);
  /// @}
  ...
  /// Print utilities for StablehloValue objects.
