...
module @jit_testcase {
  ...
  func.func private @inputs() -> tensor<15xi16> {
    %0 = stablehlo.constant dense<[1, 1, 1, -2, -1, 0, 2, 0, -3, -1, 0, -4, 2, -2, 0]> : tensor<15xi16>
  ...
  func.func private @argmin(%arg0: tensor<15xi16>) -> tensor<i32> {
    ...
    %1 = stablehlo.constant dense<32767> : tensor<i16>
    ...
    %3:2 = stablehlo.reduce(%arg0 init: %1), (%0 init: %2) across dimensions = [0] : (tensor<15xi16>, tensor<15xi32>, tensor<i16>, tensor<i32>) -> (tensor<i16>, tensor<i32>)
     reducer(%arg1: tensor<i16>, %arg3: tensor<i16>) (%arg2: tensor<i32>, %arg4: tensor<i32>)  {
      %4 = stablehlo.compare  LT, %arg1, %arg3,  SIGNED : (tensor<i16>, tensor<i16>) -> tensor<i1>
