...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %2 = call @argmin(%0) : (tensor<15xi32>) -> tensor<i32>
    %3 = stablehlo.custom_call @check.eq(%2, %1) : (tensor<i32>, tensor<i32>) -> tensor<i1>
    return %3 : tensor<i1>
  }
  func.func private @inputs() -> tensor<15xi32> {
    %0 = stablehlo.constant dense<[1, -2, 4, 2, 0, 2, 2, -5, 1, -2, 2, 0, -2, -3, -1]> : tensor<15xi32>
  ...
  func.func private @argmin(%arg0: tensor<15xi32>) -> tensor<i32> {
