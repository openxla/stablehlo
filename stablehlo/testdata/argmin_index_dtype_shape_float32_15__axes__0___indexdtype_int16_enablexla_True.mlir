...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %2 = call @argmin(%0) : (tensor<15xf32>) -> tensor<i16>
    %3 = stablehlo.custom_call @check.eq(%2, %1) : (tensor<i16>, tensor<i16>) -> tensor<i1>
    return %3 : tensor<i1>
  }
  func.func private @inputs() -> tensor<15xf32> {
    %0 = stablehlo.constant dense<[2.625650e+00, 0.839374065, 0.706070781, -1.41965759, -6.41600418, -4.10582924, 0.557202458, -0.346322298, -2.49242377, 4.02447891, 0.776593804, -1.01342976, 1.62829983, 0.751603842, -2.03670764]> : tensor<15xf32>
  ...
  func.func private @argmin(%arg0: tensor<15xf32>) -> tensor<i16> {
