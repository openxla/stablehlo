...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %2 = call @argmin(%0) : (tensor<1xf32>) -> tensor<i32>
  ...
  func.func private @argmin(%arg0: tensor<1xf32>) -> tensor<i32> {
    ...
    %3:2 = stablehlo.reduce(%arg0 init: %1), (%0 init: %2) across dimensions = [0] : (tensor<1xf32>, tensor<1xi32>, tensor<f32>, tensor<i32>) -> (tensor<f32>, tensor<i32>)
