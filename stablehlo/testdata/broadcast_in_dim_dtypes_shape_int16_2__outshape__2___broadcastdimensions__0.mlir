...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %2 = stablehlo.custom_call @check.eq(%0, %1) : (tensor<2xi16>, tensor<2xi16>) -> tensor<i1>
    return %2 : tensor<i1>
  }
  func.func private @inputs() -> tensor<2xi16> {
    %0 = stablehlo.constant dense<[-3, 0]> : tensor<2xi16>
