...
module @jit_testcase {
  ...
  func.func private @inputs() -> tensor<8x9xui16> {
    %0 = stablehlo.constant dense<[[0, 0, 1, 1, 1, 1, 3, 0, 0], [1, 2, 3, 4, 1, 0, 3, 6, 3], [0, 0, 3, 0, 4, 3, 4, 2, 0], [2, 0, 1, 1, 1, 1, 0, 0, 1], [3, 6, 1, 1, 0, 4, 1, 2, 1], [1, 0, 2, 1, 0, 2, 0, 5, 0], [0, 1, 0, 1, 2, 0, 3, 0, 1], [1, 1, 1, 4, 5, 4, 3, 2, 4]]> : tensor<8x9xui16>
    return %0 : tensor<8x9xui16>
  }
  func.func private @expected() -> tensor<8x9xui16> {
    %0 = stablehlo.constant dense<[[0, 0, 1, 1, 1, 1, 3, 0, 0], [1, 2, 3, 4, 1, 1, 3, 6, 3], [1, 2, 3, 4, 4, 3, 4, 6, 3], [2, 2, 3, 4, 4, 3, 4, 6, 3], [3, 6, 3, 4, 4, 4, 4, 6, 3], [3, 6, 3, 4, 4, 4, 4, 6, 3], [3, 6, 3, 4, 4, 4, 4, 6, 3], [3, 6, 3, 4, 5, 4, 4, 6, 4]]> : tensor<8x9xui16>
    return %0 : tensor<8x9xui16>
  }
