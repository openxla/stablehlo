...
module @jit_testcase {
  ...
  func.func private @inputs() -> tensor<8x9xui32> {
    %0 = stablehlo.constant dense<[[1, 0, 0, 1, 1, 0, 2, 3, 6], [2, 0, 0, 3, 2, 4, 1, 0, 4], [6, 3, 3, 4, 5, 3, 2, 1, 3], [3, 0, 0, 0, 1, 1, 1, 2, 0], [4, 0, 1, 0, 2, 2, 0, 1, 3], [1, 3, 1, 3, 0, 1, 3, 4, 1], [3, 0, 1, 1, 0, 1, 0, 0, 1], [0, 2, 1, 1, 0, 0, 0, 2, 2]]> : tensor<8x9xui32>
    return %0 : tensor<8x9xui32>
  }
  func.func private @expected() -> tensor<8x9xui32> {
    %0 = stablehlo.constant dense<[[1, 0, 0, 1, 1, 0, 2, 3, 6], [2, 0, 0, 3, 2, 4, 2, 3, 6], [6, 3, 3, 4, 5, 4, 2, 3, 6], [6, 3, 3, 4, 5, 4, 2, 3, 6], [6, 3, 3, 4, 5, 4, 2, 3, 6], [6, 3, 3, 4, 5, 4, 3, 4, 6], [6, 3, 3, 4, 5, 4, 3, 4, 6], [6, 3, 3, 4, 5, 4, 3, 4, 6]]> : tensor<8x9xui32>
    return %0 : tensor<8x9xui32>
  }
