...
module @jit_testcase {
  ...
  func.func private @inputs() -> tensor<8x9xui8> {
    %0 = stablehlo.constant dense<[[1, 2, 0, 2, 1, 0, 3, 0, 1], [3, 2, 2, 1, 3, 3, 0, 0, 4], [4, 2, 4, 0, 2, 0, 3, 1, 4], [4, 0, 0, 2, 5, 0, 0, 1, 0], [0, 2, 0, 3, 3, 3, 0, 3, 0], [2, 2, 4, 0, 0, 2, 1, 4, 2], [2, 0, 2, 1, 1, 0, 2, 4, 6], [2, 2, 1, 0, 2, 0, 6, 1, 11]]> : tensor<8x9xui8>
    return %0 : tensor<8x9xui8>
  }
  func.func private @expected() -> tensor<8x9xui8> {
    %0 = stablehlo.constant dense<[[1, 2, 0, 2, 1, 0, 3, 0, 1], [3, 2, 2, 2, 3, 3, 3, 0, 4], [4, 2, 4, 2, 3, 3, 3, 1, 4], [4, 2, 4, 2, 5, 3, 3, 1, 4], [4, 2, 4, 3, 5, 3, 3, 3, 4], [4, 2, 4, 3, 5, 3, 3, 4, 4], [4, 2, 4, 3, 5, 3, 3, 4, 6], [4, 2, 4, 3, 5, 3, 6, 4, 11]]> : tensor<8x9xui8>
    return %0 : tensor<8x9xui8>
  }
