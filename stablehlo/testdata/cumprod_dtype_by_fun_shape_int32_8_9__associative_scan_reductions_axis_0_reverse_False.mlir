...
module @jit_testcase {
  ...
  func.func private @inputs() -> tensor<8x9xi32> {
    %0 = stablehlo.constant dense<[[1, 2, 0, -5, -2, -2, 5, 1, 0], [-1, 0, 4, 2, -8, -1, 2, 0, -1], [-5, -2, 0, -1, 0, 1, 2, -5, 4], [-3, 1, 0, 0, 4, 1, 3, -1, 1], [-3, 0, 0, 0, 3, -3, -2, 1, 1], [-5, 0, 2, 0, -1, 1, 2, -3, 2], [0, -4, 0, -4, 0, -4, 5, 0, 0], [-3, 5, -6, 0, -1, -1, 0, 0, -2]]> : tensor<8x9xi32>
    return %0 : tensor<8x9xi32>
  }
  func.func private @expected() -> tensor<8x9xi32> {
    %0 = stablehlo.constant dense<[[1, 2, 0, -5, -2, -2, 5, 1, 0], [-1, 0, 0, -10, 16, 2, 10, 0, 0], [5, 0, 0, 10, 0, 2, 20, 0, 0], [-15, 0, 0, 0, 0, 2, 60, 0, 0], [45, 0, 0, 0, 0, -6, -120, 0, 0], [-225, 0, 0, 0, 0, -6, -240, 0, 0], [0, 0, 0, 0, 0, 24, -1200, 0, 0], [0, 0, 0, 0, 0, -24, 0, 0, 0]]> : tensor<8x9xi32>
    return %0 : tensor<8x9xi32>
  }
