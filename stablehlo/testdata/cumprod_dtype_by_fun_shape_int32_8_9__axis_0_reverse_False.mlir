...
module @jit_testcase {
  ...
  func.func private @inputs() -> tensor<8x9xi32> {
    %0 = stablehlo.constant dense<[[2, -3, 0, -2, 4, -1, 1, 1, -5], [0, -2, 3, 1, 2, -1, -4, 2, 0], [3, 3, 0, 1, -3, -2, -4, 0, 6], [-4, -3, -4, 4, -4, -2, -5, -3, 3], [-2, 2, 2, 0, 0, -1, 3, -5, 0], [0, 0, 0, -2, 0, 4, -1, 0, 0], [-1, 2, -2, 0, 7, 3, -3, 0, -2], [2, -5, -4, -3, 0, 3, 0, -1, 0]]> : tensor<8x9xi32>
    return %0 : tensor<8x9xi32>
  }
  func.func private @expected() -> tensor<8x9xi32> {
    %0 = stablehlo.constant dense<[[2, -3, 0, -2, 4, -1, 1, 1, -5], [0, 6, 0, -2, 8, 1, -4, 2, 0], [0, 18, 0, -2, -24, -2, 16, 0, 0], [0, -54, 0, -8, 96, 4, -80, 0, 0], [0, -108, 0, 0, 0, -4, -240, 0, 0], [0, 0, 0, 0, 0, -16, 240, 0, 0], [0, 0, 0, 0, 0, -48, -720, 0, 0], [0, 0, 0, 0, 0, -144, 0, 0, 0]]> : tensor<8x9xi32>
    return %0 : tensor<8x9xi32>
  }
