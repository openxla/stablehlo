...
module @jit_testcase {
  ...
  func.func private @inputs() -> tensor<8x9xui16> {
    %0 = stablehlo.constant dense<[[5, 3, 6, 1, 0, 0, 2, 8, 2], [2, 5, 0, 3, 0, 6, 4, 0, 1], [1, 0, 2, 5, 3, 5, 4, 3, 3], [3, 0, 3, 4, 1, 2, 1, 2, 0], [3, 1, 1, 1, 1, 4, 3, 1, 1], [3, 7, 4, 2, 3, 2, 1, 0, 4], [0, 3, 1, 3, 8, 1, 3, 6, 7], [0, 2, 1, 1, 5, 1, 0, 0, 3]]> : tensor<8x9xui16>
    return %0 : tensor<8x9xui16>
  }
  func.func private @expected() -> tensor<8x9xui16> {
    %0 = stablehlo.constant dense<[[5, 3, 6, 1, 0, 0, 2, 8, 2], [10, 15, 0, 3, 0, 0, 8, 0, 2], [10, 0, 0, 15, 0, 0, 32, 0, 6], [30, 0, 0, 60, 0, 0, 32, 0, 0], [90, 0, 0, 60, 0, 0, 96, 0, 0], [270, 0, 0, 120, 0, 0, 96, 0, 0], [0, 0, 0, 360, 0, 0, 288, 0, 0], [0, 0, 0, 360, 0, 0, 0, 0, 0]]> : tensor<8x9xui16>
    return %0 : tensor<8x9xui16>
  }
