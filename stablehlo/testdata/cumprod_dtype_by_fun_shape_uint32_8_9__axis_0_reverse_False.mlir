...
module @jit_testcase {
  ...
  func.func private @inputs() -> tensor<8x9xui32> {
    %0 = stablehlo.constant dense<[[2, 0, 5, 1, 0, 6, 2, 1, 0], [2, 4, 4, 0, 1, 2, 0, 3, 1], [4, 6, 4, 0, 2, 1, 1, 1, 0], [3, 2, 0, 0, 9, 1, 2, 3, 3], [6, 8, 3, 1, 4, 6, 1, 0, 1], [1, 3, 4, 0, 1, 3, 0, 5, 1], [3, 0, 0, 1, 0, 1, 6, 2, 1], [0, 3, 5, 0, 0, 5, 1, 2, 0]]> : tensor<8x9xui32>
    return %0 : tensor<8x9xui32>
  }
  func.func private @expected() -> tensor<8x9xui32> {
    %0 = stablehlo.constant dense<[[2, 0, 5, 1, 0, 6, 2, 1, 0], [4, 0, 20, 0, 0, 12, 0, 3, 0], [16, 0, 80, 0, 0, 12, 0, 3, 0], [48, 0, 0, 0, 0, 12, 0, 9, 0], [288, 0, 0, 0, 0, 72, 0, 0, 0], [288, 0, 0, 0, 0, 216, 0, 0, 0], [864, 0, 0, 0, 0, 216, 0, 0, 0], [0, 0, 0, 0, 0, 1080, 0, 0, 0]]> : tensor<8x9xui32>
    return %0 : tensor<8x9xui32>
  }
