...
module @jit_testcase {
  ...
  func.func private @inputs() -> tensor<8x9xi32> {
    %0 = stablehlo.constant dense<[[-3, 0, 0, -3, 2, -5, 1, 0, 2], [1, 0, 0, 5, 0, 0, 2, 0, 0], [0, 0, 0, -5, -2, 0, -1, 1, 2], [-2, 0, -2, -3, 1, 7, -2, 0, -2], [2, -1, 1, 2, 0, -2, 1, -2, -2], [3, 0, -2, -4, 0, 0, 0, -3, 1], [2, 0, -6, 4, -2, -2, 1, 2, 0], [4, -2, 1, 3, 1, 1, 4, -3, 0]]> : tensor<8x9xi32>
    return %0 : tensor<8x9xi32>
  }
  func.func private @expected() -> tensor<8x9xi32> {
    %0 = stablehlo.constant dense<[[-3, 0, 0, -3, 2, -5, 1, 0, 2], [-2, 0, 0, 2, 2, -5, 3, 0, 2], [-2, 0, 0, -3, 0, -5, 2, 1, 4], [-4, 0, -2, -6, 1, 2, 0, 1, 2], [-2, -1, -1, -4, 1, 0, 1, -1, 0], [1, -1, -3, -8, 1, 0, 1, -4, 1], [3, -1, -9, -4, -1, -2, 2, -2, 1], [7, -3, -8, -1, 0, -1, 6, -5, 1]]> : tensor<8x9xi32>
    return %0 : tensor<8x9xi32>
  }
