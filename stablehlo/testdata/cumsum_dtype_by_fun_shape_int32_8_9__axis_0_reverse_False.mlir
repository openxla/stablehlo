...
module @jit_testcase {
  ...
  func.func private @inputs() -> tensor<8x9xi32> {
    %0 = stablehlo.constant dense<[[1, 0, -1, 0, 0, 0, 0, -1, -6], [-2, -1, 3, 0, 1, 7, -1, -1, 4], [-2, 3, 0, 0, 4, -1, 2, 3, 0], [-3, -1, 0, 0, -3, 0, 3, 2, 1], [2, -4, -4, 0, -1, 1, 1, -2, 1], [0, 0, 1, 3, 0, -4, -2, -1, -5], [0, 6, 5, -2, 1, -3, 0, 2, 0], [4, 3, 1, -5, 1, 0, 4, 3, -1]]> : tensor<8x9xi32>
    return %0 : tensor<8x9xi32>
  }
  func.func private @expected() -> tensor<8x9xi32> {
    %0 = stablehlo.constant dense<[[1, 0, -1, 0, 0, 0, 0, -1, -6], [-1, -1, 2, 0, 1, 7, -1, -2, -2], [-3, 2, 2, 0, 5, 6, 1, 1, -2], [-6, 1, 2, 0, 2, 6, 4, 3, -1], [-4, -3, -2, 0, 1, 7, 5, 1, 0], [-4, -3, -1, 3, 1, 3, 3, 0, -5], [-4, 3, 4, 1, 2, 0, 3, 2, -5], [0, 6, 5, -4, 3, 0, 7, 5, -6]]> : tensor<8x9xi32>
    return %0 : tensor<8x9xi32>
  }
