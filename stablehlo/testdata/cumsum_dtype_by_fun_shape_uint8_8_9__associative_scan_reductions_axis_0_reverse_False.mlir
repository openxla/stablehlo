...
module @jit_testcase {
  ...
  func.func private @inputs() -> tensor<8x9xui8> {
    %0 = stablehlo.constant dense<[[1, 2, 1, 0, 0, 4, 4, 0, 0], [3, 0, 1, 0, 1, 0, 0, 0, 0], [4, 0, 3, 2, 4, 3, 5, 6, 1], [1, 1, 3, 3, 3, 1, 4, 3, 4], [3, 0, 0, 1, 1, 6, 2, 1, 1], [3, 1, 0, 3, 0, 2, 2, 1, 1], [0, 1, 2, 3, 4, 3, 2, 2, 6], [2, 2, 0, 1, 0, 3, 5, 2, 3]]> : tensor<8x9xui8>
    return %0 : tensor<8x9xui8>
  }
  func.func private @expected() -> tensor<8x9xui8> {
    %0 = stablehlo.constant dense<[[1, 2, 1, 0, 0, 4, 4, 0, 0], [4, 2, 2, 0, 1, 4, 4, 0, 0], [8, 2, 5, 2, 5, 7, 9, 6, 1], [9, 3, 8, 5, 8, 8, 13, 9, 5], [12, 3, 8, 6, 9, 14, 15, 10, 6], [15, 4, 8, 9, 9, 16, 17, 11, 7], [15, 5, 10, 12, 13, 19, 19, 13, 13], [17, 7, 10, 13, 13, 22, 24, 15, 16]]> : tensor<8x9xui8>
    return %0 : tensor<8x9xui8>
  }
