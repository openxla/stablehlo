...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %9 = stablehlo.dynamic_slice %0#0, %8, sizes = [1] : (tensor<3xui32>, tensor<i32>) -> tensor<1xui32>
    %10 = stablehlo.custom_call @check.eq(%9, %1) : (tensor<1xui32>, tensor<1xui32>) -> tensor<i1>
    return %10 : tensor<i1>
  }
  func.func private @inputs() -> (tensor<3xui32>, tensor<1xi32>) {
    %0 = stablehlo.constant dense<[3, 3, 2]> : tensor<3xui32>
    %1 = stablehlo.constant dense<1> : tensor<1xi32>
    return %0, %1 : tensor<3xui32>, tensor<1xi32>
  }
