...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<5xf32>, tensor<1xi32>) {
    %0 = stablehlo.constant dense<[-1.15815866, 4.14568615, 1.97982967, -3.34464478, 2.17626691]> : tensor<5xf32>
    %1 = stablehlo.constant dense<-4> : tensor<1xi32>
    return %0, %1 : tensor<5xf32>, tensor<1xi32>
  }
  func.func private @expected() -> tensor<2xf32> {
    %0 = stablehlo.constant dense<[4.14568615, 1.97982967]> : tensor<2xf32>
