...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %9 = stablehlo.dynamic_slice %0#0, %8, sizes = [4] : (tensor<5xf32>, tensor<i32>) -> tensor<4xf32>
    %10 = stablehlo.custom_call @check.eq(%9, %1) : (tensor<4xf32>, tensor<4xf32>) -> tensor<i1>
    return %10 : tensor<i1>
  }
  func.func private @inputs() -> (tensor<5xf32>, tensor<1xi32>) {
    %0 = stablehlo.constant dense<[1.10887885, -1.09850049, -4.60361052, 0.544419944, -1.10374165]> : tensor<5xf32>
    %1 = stablehlo.constant dense<1> : tensor<1xi32>
    return %0, %1 : tensor<5xf32>, tensor<1xi32>
  }
  func.func private @expected() -> tensor<4xf32> {
    %0 = stablehlo.constant dense<[-1.09850049, -4.60361052, 0.544419944, -1.10374165]> : tensor<4xf32>
