...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<5xf32>, tensor<1xi32>) {
    %0 = stablehlo.constant dense<[3.76223636, 6.56969356, 1.60029352, -0.843563675, 4.78096247]> : tensor<5xf32>
    %1 = stablehlo.constant dense<3> : tensor<1xi32>
    return %0, %1 : tensor<5xf32>, tensor<1xi32>
  }
  func.func private @expected() -> tensor<3xf32> {
    %0 = stablehlo.constant dense<[1.60029352, -0.843563675, 4.78096247]> : tensor<3xf32>
