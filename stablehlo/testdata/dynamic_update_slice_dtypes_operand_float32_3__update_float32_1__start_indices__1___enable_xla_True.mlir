...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3xf32>, tensor<1xf32>, tensor<1xi32>) {
    %0 = stablehlo.constant dense<[1.97990954, -7.26935053, 2.09531951]> : tensor<3xf32>
    %1 = stablehlo.constant dense<-4.17465591> : tensor<1xf32>
  ...
  func.func private @expected() -> tensor<3xf32> {
    %0 = stablehlo.constant dense<[1.97990954, -4.17465591, 2.09531951]> : tensor<3xf32>
