...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3xf32>, tensor<1xf32>, tensor<1xi32>) {
    %0 = stablehlo.constant dense<[-1.87900603, -1.71838963, 3.66749954]> : tensor<3xf32>
    %1 = stablehlo.constant dense<0.457822233> : tensor<1xf32>
  ...
  func.func private @expected() -> tensor<3xf32> {
    %0 = stablehlo.constant dense<[-1.87900603, -1.71838963, 0.457822233]> : tensor<3xf32>
