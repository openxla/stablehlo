...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3xf32>, tensor<1xf32>, tensor<1xi32>) {
    %0 = stablehlo.constant dense<[1.79273331, -4.04481936, -0.349227756]> : tensor<3xf32>
    %1 = stablehlo.constant dense<2.72959232> : tensor<1xf32>
  ...
  func.func private @expected() -> tensor<3xf32> {
    %0 = stablehlo.constant dense<[1.79273331, -4.04481936, 2.72959232]> : tensor<3xf32>
