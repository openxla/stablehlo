...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %9 = stablehlo.dynamic_update_slice %0#0, %0#1, %8 : (tensor<3xf32>, tensor<2xf32>, tensor<i32>) -> tensor<3xf32>
    %10 = stablehlo.custom_call @check.eq(%9, %1) : (tensor<3xf32>, tensor<3xf32>) -> tensor<i1>
    return %10 : tensor<i1>
  }
  func.func private @inputs() -> (tensor<3xf32>, tensor<2xf32>, tensor<1xi32>) {
    %0 = stablehlo.constant dense<[2.94359803, -1.66497409, 0.729012132]> : tensor<3xf32>
    %1 = stablehlo.constant dense<[2.11253452, -1.51363218]> : tensor<2xf32>
    %2 = stablehlo.constant dense<10> : tensor<1xi32>
    return %0, %1, %2 : tensor<3xf32>, tensor<2xf32>, tensor<1xi32>
  }
  func.func private @expected() -> tensor<3xf32> {
    %0 = stablehlo.constant dense<[2.94359803, 2.11253452, -1.51363218]> : tensor<3xf32>
