...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<f32>, tensor<2x3xf32>) {
    %0 = stablehlo.constant dense<[[-3.57334614, -1.45801294, -0.531718612], [2.09585142, 1.68692374, -2.78589964]]> : tensor<2x3xf32>
    %1 = stablehlo.constant dense<2.8598156> : tensor<f32>
