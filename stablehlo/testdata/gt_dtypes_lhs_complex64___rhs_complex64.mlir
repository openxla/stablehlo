...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %7 = stablehlo.compare  GT, %5, %6,  FLOAT : (tensor<f32>, tensor<f32>) -> tensor<i1>
    %8 = stablehlo.compare  GT, %2, %3,  FLOAT : (tensor<f32>, tensor<f32>) -> tensor<i1>
  ...
  func.func private @inputs() -> (tensor<complex<f32>>, tensor<complex<f32>>) {
    %0 = stablehlo.constant dense<(-2.83059502,-3.9340632)> : tensor<complex<f32>>
    %1 = stablehlo.constant dense<(3.64308596,1.04768276)> : tensor<complex<f32>>
