...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %2 = stablehlo.compare  LT, %0#0, %0#1,  FLOAT : (tensor<bf16>, tensor<bf16>) -> tensor<i1>
    %3 = stablehlo.custom_call @check.eq(%2, %1) : (tensor<i1>, tensor<i1>) -> tensor<i1>
    return %3 : tensor<i1>
  }
  func.func private @inputs() -> (tensor<bf16>, tensor<bf16>) {
    %0 = stablehlo.constant dense<7.062500e+00> : tensor<bf16>
    %1 = stablehlo.constant dense<-1.320310e+00> : tensor<bf16>
