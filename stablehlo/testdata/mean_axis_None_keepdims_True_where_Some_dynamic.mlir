...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32> {mhlo.sharding = ""}, %arg2: tensor<?x8x4xi1> {mhlo.sharding = ""}) -> tensor<1x1x1xf32> {
    ...
    %3 = stablehlo.reduce(%1 init: %2) across dimensions = [0, 1, 2] : (tensor<?x8x4xi64>, tensor<i64>) -> tensor<i64>
     reducer(%arg3: tensor<i64>, %arg4: tensor<i64>)  {
      %12 = stablehlo.add %arg3, %arg4 : tensor<i64>
      stablehlo.return %12 : tensor<i64>
    }
    %4 = stablehlo.broadcast_in_dim %3, dims = [] : (tensor<i64>) -> tensor<1x1x1xi64>
    ...
    %10 = stablehlo.convert %4 : (tensor<1x1x1xi64>) -> tensor<1x1x1xf32>
    %11 = stablehlo.divide %9, %10 : tensor<1x1x1xf32>
    return %11 : tensor<1x1x1xf32>
  }
