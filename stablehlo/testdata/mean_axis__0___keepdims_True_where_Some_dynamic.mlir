...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32> {mhlo.sharding = ""}, %arg2: tensor<?x8x4xi1> {mhlo.sharding = ""}) -> tensor<1x8x4xf32> {
    ...
    %4 = stablehlo.broadcast_in_dim %3, dims = [1, 2] : (tensor<8x4xi64>) -> tensor<1x8x4xi64>
    ...
    %10 = stablehlo.convert %4 : (tensor<1x8x4xi64>) -> tensor<1x8x4xf32>
    %11 = stablehlo.divide %9, %10 : tensor<1x8x4xf32>
    return %11 : tensor<1x8x4xf32>
  }
