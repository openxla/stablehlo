...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32> {mhlo.sharding = ""}, %arg2: tensor<?x8x4xi1> {mhlo.sharding = ""}) -> tensor<?x4xf32> {
    ...
    %7 = stablehlo.reduce(%5 init: %6) across dimensions = [1] : (tensor<?x8x4xf32>, tensor<f32>) -> tensor<?x4xf32>
     reducer(%arg3: tensor<f32>, %arg4: tensor<f32>)  {
      %10 = stablehlo.add %arg3, %arg4 : tensor<f32>
      stablehlo.return %10 : tensor<f32>
    }
    %8 = stablehlo.convert %3 : (tensor<?x4xi64>) -> tensor<?x4xf32>
    %9 = stablehlo.divide %7, %8 : tensor<?x4xf32>
    return %9 : tensor<?x4xf32>
  }
