...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %2 = stablehlo.compare  NE, %0#0, %0#1,  FLOAT : (tensor<f32>, tensor<f32>) -> tensor<i1>
    %3 = stablehlo.custom_call @check.eq(%2, %1) : (tensor<i1>, tensor<i1>) -> tensor<i1>
    return %3 : tensor<i1>
  }
  func.func private @inputs() -> (tensor<f32>, tensor<f32>) {
    %0 = stablehlo.constant dense<2.69025397> : tensor<f32>
    %1 = stablehlo.constant dense<0.602495253> : tensor<f32>
