...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %2 = stablehlo.compare  NE, %0#0, %0#1,  UNSIGNED : (tensor<ui16>, tensor<ui16>) -> tensor<i1>
    %3 = stablehlo.custom_call @check.eq(%2, %1) : (tensor<i1>, tensor<i1>) -> tensor<i1>
    return %3 : tensor<i1>
  }
  func.func private @inputs() -> (tensor<ui16>, tensor<ui16>) {
    %0 = stablehlo.constant dense<2> : tensor<ui16>
    %1 = stablehlo.constant dense<2> : tensor<ui16>
