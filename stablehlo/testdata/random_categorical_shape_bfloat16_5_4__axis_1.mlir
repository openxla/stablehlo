...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %63 = call @argmax(%62) : (tensor<5x4xbf16>) -> tensor<5xi32>
  ...
  func.func private @inputs() -> (tensor<2xui32>, tensor<5x4xbf16>) {
    ...
    %1 = stablehlo.constant dense<[[5.000000e+00, 3.296880e+00, 6.445310e-01, 3.496090e-01], [-2.546880e+00, -1.789060e+00, -1.609380e+00, -1.054690e+00], [4.250000e+00, 5.351560e-01, -2.703130e+00, 4.375000e+00], [1.250000e+00, 2.125000e+00, -3.859380e+00, 1.054690e+00], [-2.255860e-01, -3.144530e-01, -8.437500e-01, -8.203130e-01]]> : tensor<5x4xbf16>
    return %0, %1 : tensor<2xui32>, tensor<5x4xbf16>
  }
  func.func private @expected() -> tensor<5xi32> {
    %0 = stablehlo.constant dense<[0, 2, 3, 1, 0]> : tensor<5xi32>
    return %0 : tensor<5xi32>
  }
  func.func private @argmax(%arg0: tensor<5x4xbf16>) -> tensor<5xi32> {
    ...
    %3:2 = stablehlo.reduce(%arg0 init: %1), (%0 init: %2) across dimensions = [1] : (tensor<5x4xbf16>, tensor<5x4xi32>, tensor<bf16>, tensor<i32>) -> (tensor<5xbf16>, tensor<5xi32>)
