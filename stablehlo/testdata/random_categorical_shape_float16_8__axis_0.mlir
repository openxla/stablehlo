...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    %0:2 = call @inputs() : () -> (tensor<2xui32>, tensor<8xf16>)
    ...
    %46 = stablehlo.bitcast_convert %45 : (tensor<8xui16>) -> tensor<8xf16>
    %47 = stablehlo.constant dense<1.000000e+00> : tensor<f16>
    %48 = stablehlo.broadcast_in_dim %47, dims = [] : (tensor<f16>) -> tensor<8xf16>
    %49 = stablehlo.subtract %46, %48 : tensor<8xf16>
    %50 = stablehlo.subtract %5, %3 : tensor<1xf16>
    %51 = stablehlo.broadcast_in_dim %50, dims = [0] : (tensor<1xf16>) -> tensor<8xf16>
    %52 = stablehlo.multiply %49, %51 : tensor<8xf16>
    %53 = stablehlo.broadcast_in_dim %3, dims = [0] : (tensor<1xf16>) -> tensor<8xf16>
    %54 = stablehlo.add %52, %53 : tensor<8xf16>
    %55 = stablehlo.broadcast_in_dim %3, dims = [0] : (tensor<1xf16>) -> tensor<8xf16>
    %56 = stablehlo.maximum %55, %54 : tensor<8xf16>
    %57 = stablehlo.log %56 : tensor<8xf16>
    %58 = stablehlo.negate %57 : tensor<8xf16>
    %59 = stablehlo.log %58 : tensor<8xf16>
    %60 = stablehlo.negate %59 : tensor<8xf16>
    %61 = stablehlo.add %60, %0#1 : tensor<8xf16>
    %62 = call @argmax(%61) : (tensor<8xf16>) -> tensor<i32>
    %63 = stablehlo.custom_call @check.eq(%62, %1) : (tensor<i32>, tensor<i32>) -> tensor<i1>
    return %63 : tensor<i1>
  }
  func.func private @inputs() -> (tensor<2xui32>, tensor<8xf16>) {
    %0 = stablehlo.constant dense<[42, 43]> : tensor<2xui32>
    %1 = stablehlo.constant dense<[-2.380860e+00, -2.152340e+00, 6.100460e-02, 9.975580e-01, 7.768550e-01, 2.921880e+00, 3.269040e-01, 7.612300e-01]> : tensor<8xf16>
    return %0, %1 : tensor<2xui32>, tensor<8xf16>
  }
  func.func private @expected() -> tensor<i32> {
    %0 = stablehlo.constant dense<3> : tensor<i32>
    return %0 : tensor<i32>
  }
  func.func private @argmax(%arg0: tensor<8xf16>) -> tensor<i32> {
    %0 = stablehlo.iota dim = 0 : tensor<8xi32>
    %1 = stablehlo.constant dense<0xFC00> : tensor<f16>
    %2 = stablehlo.constant dense<0> : tensor<i32>
    %3:2 = stablehlo.reduce(%arg0 init: %1), (%0 init: %2) across dimensions = [0] : (tensor<8xf16>, tensor<8xi32>, tensor<f16>, tensor<i32>) -> (tensor<f16>, tensor<i32>)
