...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    %0:2 = call @inputs() : () -> (tensor<2xui32>, tensor<f32>)
    %1 = call @expected() : () -> tensor<f32>
    %2 = call @gamma(%0#0, %0#1) : (tensor<2xui32>, tensor<f32>) -> tensor<f32>
    %3 = stablehlo.custom_call @check.eq(%2, %1) : (tensor<f32>, tensor<f32>) -> tensor<i1>
    return %3 : tensor<i1>
  }
  func.func private @inputs() -> (tensor<2xui32>, tensor<f32>) {
    %0 = stablehlo.constant dense<[42, 43]> : tensor<2xui32>
    %1 = stablehlo.constant dense<4.15752888> : tensor<f32>
    return %0, %1 : tensor<2xui32>, tensor<f32>
  }
  func.func private @expected() -> tensor<f32> {
    %0 = stablehlo.constant dense<7.57276821> : tensor<f32>
    return %0 : tensor<f32>
  }
  func.func private @gamma(%arg0: tensor<2xui32>, %arg1: tensor<f32>) -> tensor<f32> {
    ...
    %18 = stablehlo.add %8, %10 : tensor<1x1xui32>
    %19 = stablehlo.add %9, %11 : tensor<1x1xui32>
    %20 = stablehlo.constant dense<0> : tensor<i32>
    %21 = stablehlo.constant dense<0> : tensor<i32>
    %22:9 = stablehlo.while(%iterArg = %21, %iterArg_0 = %20, %iterArg_1 = %18, %iterArg_2 = %19, %iterArg_3 = %11, %iterArg_4 = %17, %iterArg_5 = %10, %iterArg_6 = %12, %iterArg_7 = %13) : tensor<i32>, tensor<i32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<4xui32>, tensor<4xui32>
     cond {
      ...
      %38 = stablehlo.shift_left %iterArg_2, %37 : tensor<1x1xui32>
      %39 = stablehlo.constant dense<32> : tensor<ui32>
      %40 = stablehlo.subtract %39, %35 : tensor<ui32>
      %41 = stablehlo.broadcast_in_dim %40, dims = [] : (tensor<ui32>) -> tensor<1x1xui32>
      ...
      %49 = stablehlo.shift_left %44, %48 : tensor<1x1xui32>
      %50 = stablehlo.constant dense<32> : tensor<ui32>
      %51 = stablehlo.subtract %50, %46 : tensor<ui32>
      %52 = stablehlo.broadcast_in_dim %51, dims = [] : (tensor<ui32>) -> tensor<1x1xui32>
      ...
      %60 = stablehlo.shift_left %55, %59 : tensor<1x1xui32>
      %61 = stablehlo.constant dense<32> : tensor<ui32>
      %62 = stablehlo.subtract %61, %57 : tensor<ui32>
      %63 = stablehlo.broadcast_in_dim %62, dims = [] : (tensor<ui32>) -> tensor<1x1xui32>
      ...
      %71 = stablehlo.shift_left %66, %70 : tensor<1x1xui32>
      %72 = stablehlo.constant dense<32> : tensor<ui32>
      %73 = stablehlo.subtract %72, %68 : tensor<ui32>
      %74 = stablehlo.broadcast_in_dim %73, dims = [] : (tensor<ui32>) -> tensor<1x1xui32>
      %75 = stablehlo.shift_right_logical %66, %74 : tensor<1x1xui32>
      %76 = stablehlo.or %71, %75 : tensor<1x1xui32>
      %77 = stablehlo.xor %69, %76 : tensor<1x1xui32>
      %78 = stablehlo.add %69, %iterArg_3 : tensor<1x1xui32>
      %79 = stablehlo.add %77, %iterArg_4 : tensor<1x1xui32>
      %80 = stablehlo.constant dense<1> : tensor<i32>
      %81 = stablehlo.add %iterArg_0, %80 : tensor<i32>
      %82 = stablehlo.convert %81 : (tensor<i32>) -> tensor<ui32>
      %83 = stablehlo.broadcast_in_dim %82, dims = [] : (tensor<ui32>) -> tensor<1x1xui32>
      %84 = stablehlo.add %79, %83 : tensor<1x1xui32>
      %85 = stablehlo.constant dense<1> : tensor<i32>
      %86 = stablehlo.add %iterArg, %85 : tensor<i32>
      stablehlo.return %86, %33, %78, %84, %iterArg_4, %iterArg_5, %iterArg_3, %iterArg_7, %iterArg_6 : tensor<i32>, tensor<i32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<1x1xui32>, tensor<4xui32>, tensor<4xui32>
    }
    %23 = stablehlo.concatenate %22#2, %22#3, dim = 1 : (tensor<1x1xui32>, tensor<1x1xui32>) -> tensor<1x2xui32>
    %24 = stablehlo.reshape %23 : (tensor<1x2xui32>) -> tensor<1x1x2xui32>
    %25 = stablehlo.reshape %24 : (tensor<1x1x2xui32>) -> tensor<1x2xui32>
    %26 = stablehlo.reshape %arg1 : (tensor<f32>) -> tensor<1xf32>
    ...
    %30:4 = stablehlo.while(%iterArg = %25, %iterArg_0 = %26, %iterArg_1 = %29, %iterArg_2 = %28) : tensor<1x2xui32>, tensor<1xf32>, tensor<i32>, tensor<1xf32>
     cond {
      %32 = stablehlo.constant dense<1> : tensor<i32>
      ...
      %39 = stablehlo.dynamic_slice %iterArg, %37, %38, sizes = [1, 2] : (tensor<1x2xui32>, tensor<i32>, tensor<i32>) -> tensor<1x2xui32>
      ...
      %47 = stablehlo.dynamic_slice %iterArg_0, %46, sizes = [1] : (tensor<1xf32>, tensor<i32>) -> tensor<1xf32>
      ...
      %148 = stablehlo.dynamic_update_slice %iterArg_2, %141, %147 : (tensor<1xf32>, tensor<1xf32>, tensor<i32>) -> tensor<1xf32>
      %149 = stablehlo.constant dense<1> : tensor<i32>
      %150 = stablehlo.add %iterArg_1, %149 : tensor<i32>
      stablehlo.return %iterArg, %iterArg_0, %150, %148 : tensor<1x2xui32>, tensor<1xf32>, tensor<i32>, tensor<1xf32>
    }
    %31 = stablehlo.reshape %30#3 : (tensor<1xf32>) -> tensor<f32>
