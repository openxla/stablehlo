...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %43 = stablehlo.constant dense<9> : tensor<ui16>
    %44 = stablehlo.shift_right_logical %42, %43 : tensor<ui16>
    %45 = stablehlo.constant dense<16256> : tensor<ui16>
    %46 = stablehlo.or %44, %45 : tensor<ui16>
    %47 = stablehlo.bitcast_convert %46 : (tensor<ui16>) -> tensor<bf16>
    %48 = stablehlo.constant dense<1.000000e+00> : tensor<bf16>
    %49 = stablehlo.subtract %47, %48 : tensor<bf16>
    %50 = stablehlo.constant dense<1.000000e+00> : tensor<bf16>
    %51 = stablehlo.constant dense<0.000000e+00> : tensor<bf16>
    %52 = stablehlo.subtract %50, %51 : tensor<bf16>
    %53 = stablehlo.multiply %49, %52 : tensor<bf16>
    %54 = stablehlo.constant dense<0.000000e+00> : tensor<bf16>
  ...
  func.func private @expected() -> tensor<bf16> {
    %0 = stablehlo.constant dense<8.750000e-01> : tensor<bf16>
