...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %1 = call @expected() : () -> tensor<5x4xf16>
    ...
    %58 = stablehlo.custom_call @check.eq(%57, %1) : (tensor<5x4xf16>, tensor<5x4xf16>) -> tensor<i1>
    return %58 : tensor<i1>
  }
  ...
  func.func private @expected() -> tensor<5x4xf16> {
    %0 = stablehlo.constant dense<[[5.371090e-01, 7.890630e-01, 5.927730e-01, 7.109380e-01], [3.251950e-01, 6.005860e-01, 9.052730e-01, 4.482420e-01], [3.808590e-02, 1.552730e-01, 8.974600e-01, 2.333980e-01], [5.976560e-01, 5.585940e-01, 8.300780e-01, 7.226560e-01], [9.541010e-01, 4.707030e-01, 2.812500e-01, 1.054690e-01]]> : tensor<5x4xf16>
    return %0 : tensor<5x4xf16>
  }
}
