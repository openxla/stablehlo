...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    }) {base_dilations = dense<1> : tensor<1xi64>, padding = dense<0> : tensor<1x2xi64>, window_dilations = dense<1> : tensor<1xi64>, window_dimensions = dense<2> : tensor<1xi64>, window_strides = dense<1> : tensor<1xi64>} : (tensor<2xf32>, tensor<f32>) -> tensor<1xf32>
