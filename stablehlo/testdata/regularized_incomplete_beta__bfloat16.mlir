...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %2 = call @regularized_incomplete_beta(%0#0, %0#1, %0#2) : (tensor<9xbf16>, tensor<9xbf16>, tensor<9xbf16>) -> tensor<9xbf16>
    %3 = stablehlo.custom_call @check.eq(%2, %1) : (tensor<9xbf16>, tensor<9xbf16>) -> tensor<i1>
    return %3 : tensor<i1>
  }
  func.func private @inputs() -> (tensor<9xbf16>, tensor<9xbf16>, tensor<9xbf16>) {
    %0 = stablehlo.constant dense<[-1.601560e+00, -1.398440e+00, -1.000000e+00, 0.000000e+00, 1.000980e-01, 3.007810e-01, 1.000000e+00, 1.398440e+00, 1.601560e+00]> : tensor<9xbf16>
    %1 = stablehlo.constant dense<[-1.601560e+00, 1.398440e+00, 1.000000e+00, 0.000000e+00, 2.001950e-01, 1.000980e-01, 1.000000e+00, 1.398440e+00, -1.601560e+00]> : tensor<9xbf16>
    %2 = stablehlo.constant dense<[1.000000e+00, -1.000000e+00, 2.000000e+00, 1.000000e+00, 3.007810e-01, 3.007810e-01, -1.000000e+00, 2.406250e+00, 1.601560e+00]> : tensor<9xbf16>
    return %0, %1, %2 : tensor<9xbf16>, tensor<9xbf16>, tensor<9xbf16>
  }
  func.func private @expected() -> tensor<9xbf16> {
    %0 = stablehlo.constant dense<[0x7FC0, 0x7FC0, 0x7FC0, 0x7FC0, 6.210940e-01, 1.943360e-01, 0x7FC0, 0x7FC0, 0x7FC0]> : tensor<9xbf16>
    return %0 : tensor<9xbf16>
  }
  func.func private @regularized_incomplete_beta(%arg0: tensor<9xbf16>, %arg1: tensor<9xbf16>, %arg2: tensor<9xbf16>) -> tensor<9xbf16> {
    %0 = call @xla_fallback_regularized_incomplete_beta(%arg0, %arg1, %arg2) : (tensor<9xbf16>, tensor<9xbf16>, tensor<9xbf16>) -> tensor<9xbf16>
    return %0 : tensor<9xbf16>
  }
  ...
  func.func private @xla_fallback_regularized_incomplete_beta(%arg0: tensor<9xbf16>, %arg1: tensor<9xbf16>, %arg2: tensor<9xbf16>) -> tensor<9xbf16> {
    ...
    %19 = stablehlo.convert %arg2 : (tensor<9xbf16>) -> tensor<9xf32>
    %20 = stablehlo.convert %arg0 : (tensor<9xbf16>) -> tensor<9xf32>
    ...
    %24 = stablehlo.convert %arg1 : (tensor<9xbf16>) -> tensor<9xf32>
    ...
    %466 = stablehlo.convert %465 : (tensor<9xf32>) -> tensor<9xbf16>
    return %466 : tensor<9xbf16>
  }
}
