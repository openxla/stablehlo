...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %2 = stablehlo.round_nearest_afz %0 : tensor<2x5xf32>
  ...
  func.func private @expected() -> tensor<2x5xf32> {
    %0 = stablehlo.constant dense<[[1.000000e+00, 1.000000e+00, 2.000000e+00, 2.000000e+00, 3.000000e+00], [-1.000000e+00, -1.000000e+00, -2.000000e+00, -2.000000e+00, -3.000000e+00]]> : tensor<2x5xf32>
    return %0 : tensor<2x5xf32>
  }
}
