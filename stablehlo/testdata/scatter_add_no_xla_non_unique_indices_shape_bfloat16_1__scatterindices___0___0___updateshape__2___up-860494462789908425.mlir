...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1xbf16>, tensor<2xbf16>) {
    %0 = stablehlo.constant dense<6.738280e-02> : tensor<1xbf16>
    %1 = stablehlo.constant dense<[1.875000e-01, -2.171880e+00]> : tensor<2xbf16>
    return %0, %1 : tensor<1xbf16>, tensor<2xbf16>
  }
  func.func private @expected() -> tensor<1xbf16> {
    %0 = stablehlo.constant dense<-1.921880e+00> : tensor<1xbf16>
