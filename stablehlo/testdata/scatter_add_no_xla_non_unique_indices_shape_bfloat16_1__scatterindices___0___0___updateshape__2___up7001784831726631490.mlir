...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1xbf16>, tensor<2xbf16>) {
    %0 = stablehlo.constant dense<-4.179690e-01> : tensor<1xbf16>
    %1 = stablehlo.constant dense<[-3.171880e+00, 5.281250e+00]> : tensor<2xbf16>
    return %0, %1 : tensor<1xbf16>, tensor<2xbf16>
  }
  func.func private @expected() -> tensor<1xbf16> {
    %0 = stablehlo.constant dense<1.687500e+00> : tensor<1xbf16>
