...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1xf32>, tensor<2xf32>) {
    %0 = stablehlo.constant dense<-1.64504719> : tensor<1xf32>
    %1 = stablehlo.constant dense<[-1.81483185, 2.19362879]> : tensor<2xf32>
    return %0, %1 : tensor<1xf32>, tensor<2xf32>
  }
  func.func private @expected() -> tensor<1xf32> {
    %0 = stablehlo.constant dense<-1.26625013> : tensor<1xf32>
