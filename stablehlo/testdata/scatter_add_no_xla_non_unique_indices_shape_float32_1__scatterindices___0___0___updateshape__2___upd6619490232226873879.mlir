...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1xf32>, tensor<2xf32>) {
    %0 = stablehlo.constant dense<3.44075775> : tensor<1xf32>
    %1 = stablehlo.constant dense<[-2.904320e+00, -4.04776287]> : tensor<2xf32>
    return %0, %1 : tensor<1xf32>, tensor<2xf32>
  }
  func.func private @expected() -> tensor<1xf32> {
    %0 = stablehlo.constant dense<-3.51132512> : tensor<1xf32>
