...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<2x3xi32>, tensor<2x1x3xi32>) {
    %0 = stablehlo.constant dense<[[-6, 0, 2], [-6, 0, -2]]> : tensor<2x3xi32>
    %1 = stablehlo.constant dense<[[[0, 1, 1]], [[0, 0, 2]]]> : tensor<2x1x3xi32>
    return %0, %1 : tensor<2x3xi32>, tensor<2x1x3xi32>
  }
  func.func private @expected() -> tensor<2x3xi32> {
    %0 = stablehlo.constant dense<[[-6, 0, 4], [-6, 0, 0]]> : tensor<2x3xi32>
