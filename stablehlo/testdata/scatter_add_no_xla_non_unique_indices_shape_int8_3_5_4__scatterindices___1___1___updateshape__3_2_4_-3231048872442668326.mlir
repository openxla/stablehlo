...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3x5x4xi8>, tensor<3x2x4xi8>) {
    %0 = stablehlo.constant dense<[[[-3, 2, 1, -1], [4, -2, 0, 3], [0, -1, 2, 2], [1, -4, 0, -2], [0, 0, -2, 0]], [[-4, 1, -1, 0], [0, 4, -2, 0], [0, 0, -1, -5], [0, -2, 2, 0], [-2, 1, -1, 0]], [[-2, 2, 0, 1], [-3, 2, -1, 1], [0, -4, -1, 0], [-3, -1, -2, 6], [4, 1, -1, -5]]]> : tensor<3x5x4xi8>
    %1 = stablehlo.constant dense<[[[-3, 0, 1, -1], [0, 4, 6, 1]], [[1, 1, 2, 0], [0, 1, 1, 2]], [[0, 1, -2, 7], [0, 1, 3, -2]]]> : tensor<3x2x4xi8>
    return %0, %1 : tensor<3x5x4xi8>, tensor<3x2x4xi8>
  }
  func.func private @expected() -> tensor<3x5x4xi8> {
    %0 = stablehlo.constant dense<[[[-3, 2, 1, -1], [1, 2, 7, 3], [0, -1, 2, 2], [1, -4, 0, -2], [0, 0, -2, 0]], [[-4, 1, -1, 0], [1, 6, 1, 2], [0, 0, -1, -5], [0, -2, 2, 0], [-2, 1, -1, 0]], [[-2, 2, 0, 1], [-3, 4, 0, 6], [0, -4, -1, 0], [-3, -1, -2, 6], [4, 1, -1, -5]]]> : tensor<3x5x4xi8>
