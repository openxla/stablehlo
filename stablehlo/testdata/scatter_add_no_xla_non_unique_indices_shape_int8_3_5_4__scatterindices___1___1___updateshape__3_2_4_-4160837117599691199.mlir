...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3x5x4xi8>, tensor<3x2x4xi8>) {
    %0 = stablehlo.constant dense<[[[4, 1, 3, -2], [0, 2, 0, 0], [5, -1, 1, 2], [-1, -2, 3, 0], [-1, 0, 4, 2]], [[0, 5, 0, 0], [-1, -3, -1, 1], [0, 8, -2, 1], [-1, 0, 7, 3], [1, 0, 0, 0]], [[0, 0, -1, 3], [-2, -5, 2, 4], [-2, -2, 1, 7], [-6, -2, 0, -2], [4, 0, 7, 0]]]> : tensor<3x5x4xi8>
    %1 = stablehlo.constant dense<[[[0, -3, 0, 0], [1, 2, -6, 3]], [[0, -3, -1, 1], [-1, -1, 2, -3]], [[-3, 0, 2, -2], [3, 7, 0, -4]]]> : tensor<3x2x4xi8>
    return %0, %1 : tensor<3x5x4xi8>, tensor<3x2x4xi8>
  }
  func.func private @expected() -> tensor<3x5x4xi8> {
    %0 = stablehlo.constant dense<[[[4, 1, 3, -2], [1, 1, -6, 3], [5, -1, 1, 2], [-1, -2, 3, 0], [-1, 0, 4, 2]], [[0, 5, 0, 0], [-2, -7, 0, -1], [0, 8, -2, 1], [-1, 0, 7, 3], [1, 0, 0, 0]], [[0, 0, -1, 3], [-2, 2, 4, -2], [-2, -2, 1, 7], [-6, -2, 0, -2], [4, 0, 7, 0]]]> : tensor<3x5x4xi8>
