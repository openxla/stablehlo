...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3x5x4xui32>, tensor<3x2x4xui32>) {
    %0 = stablehlo.constant dense<[[[1, 0, 2, 4], [5, 1, 0, 0], [2, 0, 1, 0], [2, 2, 0, 3], [4, 7, 0, 3]], [[1, 0, 1, 3], [5, 2, 2, 0], [2, 6, 0, 2], [3, 4, 7, 4], [4, 1, 1, 2]], [[1, 4, 0, 1], [3, 4, 1, 1], [7, 1, 4, 0], [1, 1, 2, 3], [1, 2, 1, 1]]]> : tensor<3x5x4xui32>
    %1 = stablehlo.constant dense<[[[2, 0, 0, 0], [3, 1, 1, 3]], [[0, 0, 0, 0], [0, 0, 5, 1]], [[3, 0, 0, 4], [1, 3, 1, 0]]]> : tensor<3x2x4xui32>
    return %0, %1 : tensor<3x5x4xui32>, tensor<3x2x4xui32>
  }
  func.func private @expected() -> tensor<3x5x4xui32> {
    %0 = stablehlo.constant dense<[[[1, 0, 2, 4], [10, 2, 1, 3], [2, 0, 1, 0], [2, 2, 0, 3], [4, 7, 0, 3]], [[1, 0, 1, 3], [5, 2, 7, 1], [2, 6, 0, 2], [3, 4, 7, 4], [4, 1, 1, 2]], [[1, 4, 0, 1], [7, 7, 2, 5], [7, 1, 4, 0], [1, 1, 2, 3], [1, 2, 1, 1]]]> : tensor<3x5x4xui32>
