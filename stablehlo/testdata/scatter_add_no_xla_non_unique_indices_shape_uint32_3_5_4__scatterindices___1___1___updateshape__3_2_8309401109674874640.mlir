...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3x5x4xui32>, tensor<3x2x4xui32>) {
    %0 = stablehlo.constant dense<[[[0, 0, 0, 0], [0, 2, 2, 5], [3, 5, 1, 4], [2, 1, 3, 2], [5, 1, 3, 0]], [[0, 4, 1, 1], [1, 0, 3, 3], [1, 1, 1, 2], [3, 0, 3, 2], [2, 4, 1, 4]], [[1, 3, 3, 3], [0, 6, 4, 1], [0, 1, 4, 0], [5, 0, 2, 2], [4, 1, 0, 1]]]> : tensor<3x5x4xui32>
    %1 = stablehlo.constant dense<[[[0, 0, 0, 1], [4, 6, 0, 1]], [[1, 3, 2, 1], [1, 2, 1, 2]], [[0, 3, 2, 1], [4, 5, 0, 2]]]> : tensor<3x2x4xui32>
    return %0, %1 : tensor<3x5x4xui32>, tensor<3x2x4xui32>
  }
  func.func private @expected() -> tensor<3x5x4xui32> {
    %0 = stablehlo.constant dense<[[[0, 0, 0, 0], [4, 8, 2, 7], [3, 5, 1, 4], [2, 1, 3, 2], [5, 1, 3, 0]], [[0, 4, 1, 1], [3, 5, 6, 6], [1, 1, 1, 2], [3, 0, 3, 2], [2, 4, 1, 4]], [[1, 3, 3, 3], [4, 14, 6, 4], [0, 1, 4, 0], [5, 0, 2, 2], [4, 1, 0, 1]]]> : tensor<3x5x4xui32>
