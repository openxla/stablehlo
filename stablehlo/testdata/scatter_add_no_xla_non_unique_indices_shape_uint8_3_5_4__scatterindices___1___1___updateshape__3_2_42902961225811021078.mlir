...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3x5x4xui8>, tensor<3x2x4xui8>) {
    %0 = stablehlo.constant dense<[[[2, 6, 0, 5], [0, 0, 2, 0], [2, 0, 0, 0], [3, 1, 0, 6], [1, 0, 0, 3]], [[7, 11, 3, 1], [6, 6, 1, 1], [1, 0, 1, 0], [0, 3, 1, 4], [0, 5, 0, 0]], [[2, 1, 5, 2], [3, 2, 1, 1], [1, 3, 1, 1], [0, 0, 2, 1], [0, 3, 1, 3]]]> : tensor<3x5x4xui8>
    %1 = stablehlo.constant dense<[[[1, 2, 0, 1], [4, 2, 1, 6]], [[3, 4, 4, 1], [1, 0, 1, 5]], [[1, 2, 0, 2], [1, 0, 3, 4]]]> : tensor<3x2x4xui8>
    return %0, %1 : tensor<3x5x4xui8>, tensor<3x2x4xui8>
  }
  func.func private @expected() -> tensor<3x5x4xui8> {
    %0 = stablehlo.constant dense<[[[2, 6, 0, 5], [5, 4, 3, 7], [2, 0, 0, 0], [3, 1, 0, 6], [1, 0, 0, 3]], [[7, 11, 3, 1], [10, 10, 6, 7], [1, 0, 1, 0], [0, 3, 1, 4], [0, 5, 0, 0]], [[2, 1, 5, 2], [5, 4, 4, 7], [1, 3, 1, 1], [0, 0, 2, 1], [0, 3, 1, 3]]]> : tensor<3x5x4xui8>
