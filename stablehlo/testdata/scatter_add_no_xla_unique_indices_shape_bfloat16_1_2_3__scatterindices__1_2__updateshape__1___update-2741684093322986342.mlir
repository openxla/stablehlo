...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xbf16>, tensor<1xbf16>) {
    %0 = stablehlo.constant dense<[[[9.531250e-01, -1.625000e+00, 1.609380e+00], [4.863280e-01, 2.171880e+00, -6.500000e+00]]]> : tensor<1x2x3xbf16>
    %1 = stablehlo.constant dense<-5.875000e+00> : tensor<1xbf16>
    return %0, %1 : tensor<1x2x3xbf16>, tensor<1xbf16>
  }
  func.func private @expected() -> tensor<1x2x3xbf16> {
    %0 = stablehlo.constant dense<[[[9.531250e-01, -1.625000e+00, 1.609380e+00], [4.863280e-01, 2.171880e+00, -1.237500e+01]]]> : tensor<1x2x3xbf16>
