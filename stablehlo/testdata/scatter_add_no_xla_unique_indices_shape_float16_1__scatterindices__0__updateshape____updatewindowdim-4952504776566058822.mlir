...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1xf16>, tensor<f16>) {
    %0 = stablehlo.constant dense<3.250000e+00> : tensor<1xf16>
    %1 = stablehlo.constant dense<1.181640e+00> : tensor<f16>
    return %0, %1 : tensor<1xf16>, tensor<f16>
  }
  func.func private @expected() -> tensor<1xf16> {
    %0 = stablehlo.constant dense<4.429690e+00> : tensor<1xf16>
