...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x1xf32>, tensor<1xf32>) {
    %0 = stablehlo.constant dense<-5.19445801> : tensor<1x1xf32>
    %1 = stablehlo.constant dense<-10.1382074> : tensor<1xf32>
    return %0, %1 : tensor<1x1xf32>, tensor<1xf32>
  }
  func.func private @expected() -> tensor<1x1xf32> {
    %0 = stablehlo.constant dense<-15.3326654> : tensor<1x1xf32>
