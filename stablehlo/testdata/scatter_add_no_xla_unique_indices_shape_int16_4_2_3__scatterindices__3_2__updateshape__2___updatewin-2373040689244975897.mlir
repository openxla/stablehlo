...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<4x2x3xi16>, tensor<2xi16>) {
    %0 = stablehlo.constant dense<[[[0, 1, 1], [0, -5, -3]], [[-1, -2, 1], [-2, 2, 0]], [[-3, -1, 0], [-3, 3, 0]], [[0, -3, 1], [-1, -3, -2]]]> : tensor<4x2x3xi16>
    %1 = stablehlo.constant dense<[-3, 3]> : tensor<2xi16>
    return %0, %1 : tensor<4x2x3xi16>, tensor<2xi16>
  }
  func.func private @expected() -> tensor<4x2x3xi16> {
    %0 = stablehlo.constant dense<[[[0, 1, 1], [0, -5, -3]], [[-1, -2, 1], [-2, 2, 0]], [[-3, -1, 0], [-3, 3, 0]], [[0, -3, -2], [-1, -3, 1]]]> : tensor<4x2x3xi16>
