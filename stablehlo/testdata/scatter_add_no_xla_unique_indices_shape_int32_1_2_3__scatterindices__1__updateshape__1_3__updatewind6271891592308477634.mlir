...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xi32>, tensor<1x3xi32>) {
    %0 = stablehlo.constant dense<[[[1, 1, 3], [1, -5, -2]]]> : tensor<1x2x3xi32>
    %1 = stablehlo.constant dense<[[-7, 5, 0]]> : tensor<1x3xi32>
    return %0, %1 : tensor<1x2x3xi32>, tensor<1x3xi32>
  }
  func.func private @expected() -> tensor<1x2x3xi32> {
    %0 = stablehlo.constant dense<[[[1, 1, 3], [-6, 0, -2]]]> : tensor<1x2x3xi32>
