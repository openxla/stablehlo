...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<4x2x3xui16>, tensor<2xui16>) {
    %0 = stablehlo.constant dense<[[[1, 4, 7], [2, 0, 0]], [[1, 1, 4], [2, 4, 0]], [[0, 2, 2], [4, 2, 3]], [[1, 4, 3], [7, 2, 0]]]> : tensor<4x2x3xui16>
    %1 = stablehlo.constant dense<[2, 5]> : tensor<2xui16>
    return %0, %1 : tensor<4x2x3xui16>, tensor<2xui16>
  }
  func.func private @expected() -> tensor<4x2x3xui16> {
    %0 = stablehlo.constant dense<[[[1, 4, 7], [2, 0, 0]], [[1, 1, 4], [2, 4, 0]], [[0, 2, 2], [4, 2, 3]], [[1, 4, 5], [7, 2, 5]]]> : tensor<4x2x3xui16>
