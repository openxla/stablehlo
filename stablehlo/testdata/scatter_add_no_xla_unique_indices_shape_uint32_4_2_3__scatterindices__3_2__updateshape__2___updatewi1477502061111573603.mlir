...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<4x2x3xui32>, tensor<2xui32>) {
    %0 = stablehlo.constant dense<[[[0, 2, 2], [2, 2, 1]], [[1, 0, 1], [2, 1, 0]], [[2, 0, 1], [2, 3, 1]], [[0, 0, 0], [0, 0, 3]]]> : tensor<4x2x3xui32>
  ...
  func.func private @expected() -> tensor<4x2x3xui32> {
    %0 = stablehlo.constant dense<[[[0, 2, 2], [2, 2, 1]], [[1, 0, 1], [2, 1, 0]], [[2, 0, 1], [2, 3, 1]], [[0, 0, 0], [0, 0, 4]]]> : tensor<4x2x3xui32>
