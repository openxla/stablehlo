...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<5xf32>, tensor<2xf32>) {
    %0 = stablehlo.constant dense<[-2.34540415, -2.17804718, 7.387220e-01, -2.66740251, -2.79656339]> : tensor<5xf32>
    %1 = stablehlo.constant dense<[1.897000e+00, -1.37782645]> : tensor<2xf32>
    return %0, %1 : tensor<5xf32>, tensor<2xf32>
  }
  func.func private @expected() -> tensor<5xf32> {
    %0 = stablehlo.constant dense<[1.897000e+00, -2.17804718, -1.37782645, -2.66740251, -2.79656339]> : tensor<5xf32>
