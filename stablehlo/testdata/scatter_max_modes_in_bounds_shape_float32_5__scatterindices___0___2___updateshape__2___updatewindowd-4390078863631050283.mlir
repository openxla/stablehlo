...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<5xf32>, tensor<2xf32>) {
    %0 = stablehlo.constant dense<[0.14078936, -3.36865425, 2.28235221, 1.22103763, 1.39380562]> : tensor<5xf32>
    %1 = stablehlo.constant dense<[-5.38613462, -1.51647878]> : tensor<2xf32>
