...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x5xf32>, tensor<1xf32>) {
    %0 = stablehlo.constant dense<[[-0.571081638, -1.46668887, 0.408351898, -0.851466417, 7.38461256]]> : tensor<1x5xf32>
    %1 = stablehlo.constant dense<0.972372353> : tensor<1xf32>
