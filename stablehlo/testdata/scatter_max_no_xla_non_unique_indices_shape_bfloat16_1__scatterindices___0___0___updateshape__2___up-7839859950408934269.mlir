...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1xbf16>, tensor<2xbf16>) {
    %0 = stablehlo.constant dense<-6.593750e+00> : tensor<1xbf16>
    %1 = stablehlo.constant dense<[3.265630e+00, -1.429690e+00]> : tensor<2xbf16>
    return %0, %1 : tensor<1xbf16>, tensor<2xbf16>
  }
  func.func private @expected() -> tensor<1xbf16> {
    %0 = stablehlo.constant dense<3.265630e+00> : tensor<1xbf16>
