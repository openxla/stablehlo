...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1xf32>, tensor<2xf32>) {
    %0 = stablehlo.constant dense<0.852348208> : tensor<1xf32>
    %1 = stablehlo.constant dense<[2.81030583, 0.0699641183]> : tensor<2xf32>
    return %0, %1 : tensor<1xf32>, tensor<2xf32>
  }
  func.func private @expected() -> tensor<1xf32> {
    %0 = stablehlo.constant dense<2.81030583> : tensor<1xf32>
