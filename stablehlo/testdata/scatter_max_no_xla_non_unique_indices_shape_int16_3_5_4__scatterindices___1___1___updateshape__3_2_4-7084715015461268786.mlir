...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3x5x4xi16>, tensor<3x2x4xi16>) {
    %0 = stablehlo.constant dense<[[[-3, 0, 0, 1], [-1, -2, -4, -9], [-4, -1, 0, -1], [0, -2, -1, 0], [2, 3, 5, 2]], [[0, 0, 3, 0], [1, 1, 0, -1], [3, 0, 0, 3], [6, 0, 1, 0], [-1, 4, 6, -1]], [[-4, 0, -5, -2], [0, -1, -1, -2], [1, 8, -2, 0], [1, 4, 0, -1], [0, 0, 1, -4]]]> : tensor<3x5x4xi16>
    %1 = stablehlo.constant dense<[[[2, 4, 4, 0], [-1, 0, 0, -2]], [[0, 0, -1, 0], [0, -3, -1, 0]], [[-3, 2, -4, -1], [1, 0, -2, 4]]]> : tensor<3x2x4xi16>
    return %0, %1 : tensor<3x5x4xi16>, tensor<3x2x4xi16>
  }
  func.func private @expected() -> tensor<3x5x4xi16> {
    %0 = stablehlo.constant dense<[[[-3, 0, 0, 1], [2, 4, 4, 0], [-4, -1, 0, -1], [0, -2, -1, 0], [2, 3, 5, 2]], [[0, 0, 3, 0], [1, 1, 0, 0], [3, 0, 0, 3], [6, 0, 1, 0], [-1, 4, 6, -1]], [[-4, 0, -5, -2], [1, 2, -1, 4], [1, 8, -2, 0], [1, 4, 0, -1], [0, 0, 1, -4]]]> : tensor<3x5x4xi16>
