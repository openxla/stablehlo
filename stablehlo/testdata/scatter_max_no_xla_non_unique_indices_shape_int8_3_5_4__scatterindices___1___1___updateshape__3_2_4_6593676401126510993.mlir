...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3x5x4xi8>, tensor<3x2x4xi8>) {
    %0 = stablehlo.constant dense<[[[1, -2, 0, 2], [2, 0, 6, -4], [4, 0, 3, 2], [1, 0, 0, -1], [0, 1, 0, 7]], [[1, 1, 0, 0], [5, -4, 1, 0], [-1, 5, 0, -1], [5, 1, -1, -7], [-4, 0, 9, 0]], [[0, -3, 0, 3], [3, -2, 2, 1], [6, 2, -2, 0], [-5, 3, 0, 0], [-1, 0, -1, -4]]]> : tensor<3x5x4xi8>
    %1 = stablehlo.constant dense<[[[1, 0, -3, 0], [0, -2, -1, -3]], [[-4, -2, 0, -2], [0, 0, -1, 0]], [[0, 0, -5, 2], [-1, -1, 3, 1]]]> : tensor<3x2x4xi8>
    return %0, %1 : tensor<3x5x4xi8>, tensor<3x2x4xi8>
  }
  func.func private @expected() -> tensor<3x5x4xi8> {
    %0 = stablehlo.constant dense<[[[1, -2, 0, 2], [2, 0, 6, 0], [4, 0, 3, 2], [1, 0, 0, -1], [0, 1, 0, 7]], [[1, 1, 0, 0], [5, 0, 1, 0], [-1, 5, 0, -1], [5, 1, -1, -7], [-4, 0, 9, 0]], [[0, -3, 0, 3], [3, 0, 3, 2], [6, 2, -2, 0], [-5, 3, 0, 0], [-1, 0, -1, -4]]]> : tensor<3x5x4xi8>
