...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3x5x4xui32>, tensor<3x2x4xui32>) {
    %0 = stablehlo.constant dense<[[[8, 4, 4, 2], [0, 1, 2, 3], [0, 0, 2, 2], [1, 0, 1, 1], [4, 2, 1, 0]], [[0, 2, 4, 2], [1, 1, 0, 1], [4, 3, 4, 3], [1, 3, 2, 1], [2, 0, 2, 3]], [[3, 1, 3, 2], [0, 4, 0, 0], [1, 3, 0, 1], [0, 0, 2, 4], [5, 0, 5, 0]]]> : tensor<3x5x4xui32>
    %1 = stablehlo.constant dense<[[[3, 0, 0, 1], [0, 2, 0, 0]], [[1, 0, 7, 2], [2, 0, 0, 1]], [[1, 4, 0, 1], [5, 3, 0, 3]]]> : tensor<3x2x4xui32>
    return %0, %1 : tensor<3x5x4xui32>, tensor<3x2x4xui32>
  }
  func.func private @expected() -> tensor<3x5x4xui32> {
    %0 = stablehlo.constant dense<[[[8, 4, 4, 2], [3, 2, 2, 3], [0, 0, 2, 2], [1, 0, 1, 1], [4, 2, 1, 0]], [[0, 2, 4, 2], [2, 1, 7, 2], [4, 3, 4, 3], [1, 3, 2, 1], [2, 0, 2, 3]], [[3, 1, 3, 2], [5, 4, 0, 3], [1, 3, 0, 1], [0, 0, 2, 4], [5, 0, 5, 0]]]> : tensor<3x5x4xui32>
