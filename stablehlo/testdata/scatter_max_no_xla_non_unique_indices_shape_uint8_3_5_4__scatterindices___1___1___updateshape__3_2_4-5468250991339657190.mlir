...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3x5x4xui8>, tensor<3x2x4xui8>) {
    %0 = stablehlo.constant dense<[[[2, 0, 1, 0], [2, 7, 4, 1], [2, 0, 0, 4], [0, 1, 6, 0], [1, 2, 1, 1]], [[4, 0, 2, 1], [0, 2, 0, 2], [7, 0, 5, 1], [4, 1, 1, 3], [4, 3, 0, 1]], [[0, 0, 3, 3], [0, 0, 2, 1], [3, 3, 6, 0], [0, 0, 2, 2], [5, 1, 2, 2]]]> : tensor<3x5x4xui8>
    %1 = stablehlo.constant dense<[[[2, 4, 2, 1], [9, 4, 0, 2]], [[3, 4, 2, 0], [1, 1, 2, 0]], [[3, 1, 3, 4], [6, 0, 2, 3]]]> : tensor<3x2x4xui8>
    return %0, %1 : tensor<3x5x4xui8>, tensor<3x2x4xui8>
  }
  func.func private @expected() -> tensor<3x5x4xui8> {
    %0 = stablehlo.constant dense<[[[2, 0, 1, 0], [9, 7, 4, 2], [2, 0, 0, 4], [0, 1, 6, 0], [1, 2, 1, 1]], [[4, 0, 2, 1], [3, 4, 2, 2], [7, 0, 5, 1], [4, 1, 1, 3], [4, 3, 0, 1]], [[0, 0, 3, 3], [6, 1, 3, 4], [3, 3, 6, 0], [0, 0, 2, 2], [5, 1, 2, 2]]]> : tensor<3x5x4xui8>
