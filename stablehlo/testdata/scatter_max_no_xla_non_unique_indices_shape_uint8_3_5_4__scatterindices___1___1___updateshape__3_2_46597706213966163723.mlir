...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3x5x4xui8>, tensor<3x2x4xui8>) {
    %0 = stablehlo.constant dense<[[[0, 6, 3, 2], [1, 0, 1, 1], [6, 5, 0, 1], [5, 1, 2, 3], [1, 1, 4, 5]], [[0, 4, 2, 2], [4, 2, 3, 1], [2, 2, 1, 1], [2, 1, 1, 1], [2, 5, 2, 1]], [[3, 1, 0, 4], [3, 1, 4, 4], [0, 1, 0, 1], [2, 4, 3, 7], [1, 5, 0, 2]]]> : tensor<3x5x4xui8>
    %1 = stablehlo.constant dense<[[[0, 2, 0, 2], [1, 0, 3, 5]], [[3, 4, 5, 2], [5, 5, 3, 1]], [[1, 0, 1, 7], [4, 2, 4, 1]]]> : tensor<3x2x4xui8>
    return %0, %1 : tensor<3x5x4xui8>, tensor<3x2x4xui8>
  }
  func.func private @expected() -> tensor<3x5x4xui8> {
    %0 = stablehlo.constant dense<[[[0, 6, 3, 2], [1, 2, 3, 5], [6, 5, 0, 1], [5, 1, 2, 3], [1, 1, 4, 5]], [[0, 4, 2, 2], [5, 5, 5, 2], [2, 2, 1, 1], [2, 1, 1, 1], [2, 5, 2, 1]], [[3, 1, 0, 4], [4, 2, 4, 7], [0, 1, 0, 1], [2, 4, 3, 7], [1, 5, 0, 2]]]> : tensor<3x5x4xui8>
