...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xbf16>, tensor<1xbf16>) {
    %0 = stablehlo.constant dense<[[[-2.437500e+00, 4.218750e+00, 6.835930e-01], [5.156250e+00, -4.125000e+00, 8.632810e-01]]]> : tensor<1x2x3xbf16>
    %1 = stablehlo.constant dense<7.958980e-02> : tensor<1xbf16>
