...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xf16>, tensor<1xf16>) {
    %0 = stablehlo.constant dense<[[[5.515630e+00, 2.103520e+00, -1.183590e+00], [-1.127930e+00, 4.312500e+00, 1.646480e+00]]]> : tensor<1x2x3xf16>
    %1 = stablehlo.constant dense<-1.647460e+00> : tensor<1xf16>
