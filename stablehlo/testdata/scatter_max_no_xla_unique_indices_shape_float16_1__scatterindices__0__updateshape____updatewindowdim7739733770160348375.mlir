...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1xf16>, tensor<f16>) {
    %0 = stablehlo.constant dense<-6.187500e+00> : tensor<1xf16>
    %1 = stablehlo.constant dense<-5.449210e+00> : tensor<f16>
    return %0, %1 : tensor<1xf16>, tensor<f16>
  }
  func.func private @expected() -> tensor<1xf16> {
    %0 = stablehlo.constant dense<-5.449210e+00> : tensor<1xf16>
