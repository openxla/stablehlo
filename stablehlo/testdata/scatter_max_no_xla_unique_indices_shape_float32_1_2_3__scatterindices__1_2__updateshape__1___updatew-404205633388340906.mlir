...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xf32>, tensor<1xf32>) {
    %0 = stablehlo.constant dense<[[[-1.78535271, 3.82053828, 5.04118919], [-4.56882715, 2.62146735, 0.0367132612]]]> : tensor<1x2x3xf32>
    %1 = stablehlo.constant dense<-0.190174133> : tensor<1xf32>
