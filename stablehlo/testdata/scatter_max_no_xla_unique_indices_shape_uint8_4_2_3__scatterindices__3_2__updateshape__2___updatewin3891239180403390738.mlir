...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<4x2x3xui8>, tensor<2xui8>) {
    %0 = stablehlo.constant dense<[[[5, 3, 2], [1, 3, 1]], [[2, 7, 3], [3, 5, 2]], [[5, 1, 2], [0, 1, 7]], [[3, 4, 0], [1, 1, 2]]]> : tensor<4x2x3xui8>
  ...
  func.func private @expected() -> tensor<4x2x3xui8> {
    %0 = stablehlo.constant dense<[[[5, 3, 2], [1, 3, 1]], [[2, 7, 3], [3, 5, 2]], [[5, 1, 2], [0, 1, 7]], [[3, 4, 2], [1, 1, 2]]]> : tensor<4x2x3xui8>
