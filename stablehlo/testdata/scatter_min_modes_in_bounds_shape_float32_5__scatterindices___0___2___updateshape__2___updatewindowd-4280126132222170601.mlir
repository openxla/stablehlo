...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<5xf32>, tensor<2xf32>) {
    %0 = stablehlo.constant dense<[-1.10114527, -3.64025712, -1.96230221, -1.87603951, 2.06735373]> : tensor<5xf32>
    %1 = stablehlo.constant dense<[-2.25583839, 4.37012053]> : tensor<2xf32>
    return %0, %1 : tensor<5xf32>, tensor<2xf32>
  }
  func.func private @expected() -> tensor<5xf32> {
    %0 = stablehlo.constant dense<[-2.25583839, -3.64025712, -1.96230221, -1.87603951, 2.06735373]> : tensor<5xf32>
