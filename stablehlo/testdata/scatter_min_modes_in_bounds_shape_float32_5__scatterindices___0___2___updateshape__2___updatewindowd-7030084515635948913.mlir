...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<5xf32>, tensor<2xf32>) {
    %0 = stablehlo.constant dense<[1.73643696, 2.86125565, 3.26151943, -3.0184288, -3.78002477]> : tensor<5xf32>
    %1 = stablehlo.constant dense<[-0.725270629, -4.01733875]> : tensor<2xf32>
    return %0, %1 : tensor<5xf32>, tensor<2xf32>
  }
  func.func private @expected() -> tensor<5xf32> {
    %0 = stablehlo.constant dense<[-0.725270629, 2.86125565, -4.01733875, -3.0184288, -3.78002477]> : tensor<5xf32>
