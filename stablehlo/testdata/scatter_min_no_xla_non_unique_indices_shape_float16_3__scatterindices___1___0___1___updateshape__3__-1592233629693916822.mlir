...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3xf16>, tensor<3xf16>) {
    %0 = stablehlo.constant dense<[2.275390e+00, -3.494140e+00, -8.769530e-01]> : tensor<3xf16>
    %1 = stablehlo.constant dense<[5.812500e+00, 7.670890e-01, -3.593750e-01]> : tensor<3xf16>
    return %0, %1 : tensor<3xf16>, tensor<3xf16>
  }
  func.func private @expected() -> tensor<3xf16> {
    %0 = stablehlo.constant dense<[7.670890e-01, -3.494140e+00, -8.769530e-01]> : tensor<3xf16>
