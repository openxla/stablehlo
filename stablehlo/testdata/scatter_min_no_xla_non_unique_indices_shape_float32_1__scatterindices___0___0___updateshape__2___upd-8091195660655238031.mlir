...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1xf32>, tensor<2xf32>) {
    %0 = stablehlo.constant dense<3.39284682> : tensor<1xf32>
    %1 = stablehlo.constant dense<[-4.01232338, -3.81568885]> : tensor<2xf32>
    return %0, %1 : tensor<1xf32>, tensor<2xf32>
  }
  func.func private @expected() -> tensor<1xf32> {
    %0 = stablehlo.constant dense<-4.01232338> : tensor<1xf32>
