...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3x5x4xi16>, tensor<3x2x4xi16>) {
    %0 = stablehlo.constant dense<[[[0, 0, -4, 0], [0, 0, 6, 1], [1, -2, 2, -2], [2, -2, 5, -2], [-7, -4, 1, -1]], [[-4, 1, -4, 3], [-5, 2, 1, -3], [-2, -4, 0, -1], [0, 3, 0, -4], [-1, -1, 2, 2]], [[0, 3, 5, -3], [1, -1, 0, 0], [0, 1, -2, -6], [-1, 1, -5, -5], [-4, 2, -2, -4]]]> : tensor<3x5x4xi16>
    %1 = stablehlo.constant dense<[[[2, 1, -2, 4], [1, 1, 0, 4]], [[-2, 3, -5, -5], [-4, -1, 3, 2]], [[3, -1, 0, 2], [0, -2, 0, 0]]]> : tensor<3x2x4xi16>
    return %0, %1 : tensor<3x5x4xi16>, tensor<3x2x4xi16>
  }
  func.func private @expected() -> tensor<3x5x4xi16> {
    %0 = stablehlo.constant dense<[[[0, 0, -4, 0], [0, 0, -2, 1], [1, -2, 2, -2], [2, -2, 5, -2], [-7, -4, 1, -1]], [[-4, 1, -4, 3], [-5, -1, -5, -5], [-2, -4, 0, -1], [0, 3, 0, -4], [-1, -1, 2, 2]], [[0, 3, 5, -3], [0, -2, 0, 0], [0, 1, -2, -6], [-1, 1, -5, -5], [-4, 2, -2, -4]]]> : tensor<3x5x4xi16>
