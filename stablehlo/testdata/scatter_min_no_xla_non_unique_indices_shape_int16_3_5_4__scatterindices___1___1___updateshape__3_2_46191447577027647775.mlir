...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3x5x4xi16>, tensor<3x2x4xi16>) {
    %0 = stablehlo.constant dense<[[[7, 0, 1, 1], [3, 2, -3, 0], [0, 0, 0, -1], [2, 0, 2, 0], [-4, 2, 1, 0]], [[-3, -1, -2, 4], [2, 1, -1, 0], [0, -2, 0, -5], [-2, 0, 0, 1], [-2, 0, -4, 4]], [[1, 0, -2, 2], [4, 2, -4, -1], [-1, 3, 4, -2], [-1, 0, 1, 7], [-3, 6, 2, 1]]]> : tensor<3x5x4xi16>
    %1 = stablehlo.constant dense<[[[1, 2, 0, 0], [0, 0, 2, 0]], [[-5, -1, 2, 5], [-7, -1, 2, -1]], [[4, 0, 5, 4], [6, 5, -1, 5]]]> : tensor<3x2x4xi16>
    return %0, %1 : tensor<3x5x4xi16>, tensor<3x2x4xi16>
  }
  func.func private @expected() -> tensor<3x5x4xi16> {
    %0 = stablehlo.constant dense<[[[7, 0, 1, 1], [0, 0, -3, 0], [0, 0, 0, -1], [2, 0, 2, 0], [-4, 2, 1, 0]], [[-3, -1, -2, 4], [-7, -1, -1, -1], [0, -2, 0, -5], [-2, 0, 0, 1], [-2, 0, -4, 4]], [[1, 0, -2, 2], [4, 0, -4, -1], [-1, 3, 4, -2], [-1, 0, 1, 7], [-3, 6, 2, 1]]]> : tensor<3x5x4xi16>
