...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3x5x4xi8>, tensor<3x2x4xi8>) {
    %0 = stablehlo.constant dense<[[[3, 0, 1, 0], [0, -3, 3, 0], [4, 3, 0, 1], [0, -2, 3, 1], [3, -2, 2, 0]], [[-2, -1, 0, 0], [-2, -8, 0, -1], [-2, 0, -5, 0], [5, -1, -4, 2], [1, 0, -4, -1]], [[-2, 6, 5, 5], [-1, 0, -1, 2], [-1, -9, -1, 0], [-3, -4, 1, 0], [0, 4, 0, -1]]]> : tensor<3x5x4xi8>
    %1 = stablehlo.constant dense<[[[-4, 0, -3, 4], [2, 2, 0, -6]], [[0, 2, 0, -1], [-4, 2, 0, -1]], [[-1, 3, 5, 3], [-2, 0, 0, -1]]]> : tensor<3x2x4xi8>
    return %0, %1 : tensor<3x5x4xi8>, tensor<3x2x4xi8>
  }
  func.func private @expected() -> tensor<3x5x4xi8> {
    %0 = stablehlo.constant dense<[[[3, 0, 1, 0], [-4, -3, -3, -6], [4, 3, 0, 1], [0, -2, 3, 1], [3, -2, 2, 0]], [[-2, -1, 0, 0], [-4, -8, 0, -1], [-2, 0, -5, 0], [5, -1, -4, 2], [1, 0, -4, -1]], [[-2, 6, 5, 5], [-2, 0, -1, -1], [-1, -9, -1, 0], [-3, -4, 1, 0], [0, 4, 0, -1]]]> : tensor<3x5x4xi8>
