...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3x5x4xui32>, tensor<3x2x4xui32>) {
    %0 = stablehlo.constant dense<[[[6, 2, 8, 4], [0, 4, 1, 5], [0, 1, 2, 1], [0, 2, 0, 2], [4, 1, 3, 3]], [[3, 0, 4, 1], [1, 1, 1, 2], [1, 2, 2, 4], [2, 1, 2, 0], [0, 2, 0, 0]], [[0, 2, 1, 4], [6, 0, 3, 5], [2, 0, 2, 2], [2, 1, 2, 0], [1, 4, 0, 1]]]> : tensor<3x5x4xui32>
    %1 = stablehlo.constant dense<[[[2, 0, 1, 0], [1, 3, 0, 4]], [[2, 4, 0, 4], [0, 1, 2, 0]], [[1, 0, 1, 0], [1, 0, 3, 2]]]> : tensor<3x2x4xui32>
    return %0, %1 : tensor<3x5x4xui32>, tensor<3x2x4xui32>
  }
  func.func private @expected() -> tensor<3x5x4xui32> {
    %0 = stablehlo.constant dense<[[[6, 2, 8, 4], [0, 0, 0, 0], [0, 1, 2, 1], [0, 2, 0, 2], [4, 1, 3, 3]], [[3, 0, 4, 1], [0, 1, 0, 0], [1, 2, 2, 4], [2, 1, 2, 0], [0, 2, 0, 0]], [[0, 2, 1, 4], [1, 0, 1, 0], [2, 0, 2, 2], [2, 1, 2, 0], [1, 4, 0, 1]]]> : tensor<3x5x4xui32>
