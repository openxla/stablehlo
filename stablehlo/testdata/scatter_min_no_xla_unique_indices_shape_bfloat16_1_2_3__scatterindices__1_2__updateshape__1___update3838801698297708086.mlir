...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xbf16>, tensor<1xbf16>) {
    %0 = stablehlo.constant dense<[[[1.308590e-01, -1.943360e-01, 4.863280e-01], [7.531250e+00, -1.945310e+00, 3.421880e+00]]]> : tensor<1x2x3xbf16>
    %1 = stablehlo.constant dense<2.937500e+00> : tensor<1xbf16>
    return %0, %1 : tensor<1x2x3xbf16>, tensor<1xbf16>
  }
  func.func private @expected() -> tensor<1x2x3xbf16> {
    %0 = stablehlo.constant dense<[[[1.308590e-01, -1.943360e-01, 4.863280e-01], [7.531250e+00, -1.945310e+00, 2.937500e+00]]]> : tensor<1x2x3xbf16>
