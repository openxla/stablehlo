...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<4x2x3xi16>, tensor<2xi16>) {
    %0 = stablehlo.constant dense<[[[0, -1, -1], [3, -3, 0]], [[-2, -1, 6], [1, 4, 1]], [[-2, 0, 3], [1, 0, -1]], [[-1, 0, -2], [3, -2, 3]]]> : tensor<4x2x3xi16>
  ...
  func.func private @expected() -> tensor<4x2x3xi16> {
    %0 = stablehlo.constant dense<[[[0, -1, -1], [3, -3, 0]], [[-2, -1, 6], [1, 4, 1]], [[-2, 0, 3], [1, 0, -1]], [[-1, 0, -2], [3, -2, -4]]]> : tensor<4x2x3xi16>
