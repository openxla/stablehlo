...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<4x2x3xui16>, tensor<2xui16>) {
    %0 = stablehlo.constant dense<[[[4, 1, 0], [1, 3, 1]], [[2, 2, 0], [1, 2, 4]], [[1, 0, 1], [0, 0, 1]], [[0, 2, 2], [5, 1, 1]]]> : tensor<4x2x3xui16>
  ...
  func.func private @expected() -> tensor<4x2x3xui16> {
    %0 = stablehlo.constant dense<[[[4, 1, 0], [1, 3, 1]], [[2, 2, 0], [1, 2, 4]], [[1, 0, 1], [0, 0, 1]], [[0, 2, 0], [5, 1, 1]]]> : tensor<4x2x3xui16>
