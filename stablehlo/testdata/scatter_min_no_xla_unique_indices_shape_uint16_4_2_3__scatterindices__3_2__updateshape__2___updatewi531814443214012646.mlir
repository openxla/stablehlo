...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<4x2x3xui16>, tensor<2xui16>) {
    %0 = stablehlo.constant dense<[[[0, 4, 3], [2, 2, 2]], [[1, 0, 0], [2, 2, 2]], [[3, 4, 5], [0, 2, 0]], [[2, 2, 1], [0, 2, 9]]]> : tensor<4x2x3xui16>
    %1 = stablehlo.constant dense<[2, 1]> : tensor<2xui16>
    return %0, %1 : tensor<4x2x3xui16>, tensor<2xui16>
  }
  func.func private @expected() -> tensor<4x2x3xui16> {
    %0 = stablehlo.constant dense<[[[0, 4, 3], [2, 2, 2]], [[1, 0, 0], [2, 2, 2]], [[3, 4, 5], [0, 2, 0]], [[2, 2, 1], [0, 2, 1]]]> : tensor<4x2x3xui16>
