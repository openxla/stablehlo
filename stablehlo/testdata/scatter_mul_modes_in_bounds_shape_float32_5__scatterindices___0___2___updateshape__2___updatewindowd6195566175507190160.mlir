...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<5xf32>, tensor<2xf32>) {
    %0 = stablehlo.constant dense<[-1.55950558, 2.34751749, -2.42971253, 2.56774545, 2.7623651]> : tensor<5xf32>
    %1 = stablehlo.constant dense<[-5.03514051, 2.26714635]> : tensor<2xf32>
    return %0, %1 : tensor<5xf32>, tensor<2xf32>
  }
  func.func private @expected() -> tensor<5xf32> {
    %0 = stablehlo.constant dense<[7.85232973, 2.34751749, -5.50851393, 2.56774545, 2.7623651]> : tensor<5xf32>
