...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1xbf16>, tensor<2xbf16>) {
    %0 = stablehlo.constant dense<-1.098630e-02> : tensor<1xbf16>
    %1 = stablehlo.constant dense<[-7.109380e-01, 1.757810e+00]> : tensor<2xbf16>
    return %0, %1 : tensor<1xbf16>, tensor<2xbf16>
  }
  func.func private @expected() -> tensor<1xbf16> {
    %0 = stablehlo.constant dense<1.373290e-02> : tensor<1xbf16>
