...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1xf32>, tensor<2xf32>) {
    %0 = stablehlo.constant dense<-2.38677382> : tensor<1xf32>
    %1 = stablehlo.constant dense<[3.01652217, -4.48554659]> : tensor<2xf32>
    return %0, %1 : tensor<1xf32>, tensor<2xf32>
  }
  func.func private @expected() -> tensor<1xf32> {
    %0 = stablehlo.constant dense<32.2948418> : tensor<1xf32>
