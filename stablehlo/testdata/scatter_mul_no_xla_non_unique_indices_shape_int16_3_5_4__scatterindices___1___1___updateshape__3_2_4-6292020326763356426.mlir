...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3x5x4xi16>, tensor<3x2x4xi16>) {
    %0 = stablehlo.constant dense<[[[1, 0, -8, 0], [0, 0, -3, 2], [0, 1, -2, 1], [-2, 1, -3, 1], [-1, -2, 0, -1]], [[0, 1, 3, -3], [0, -4, 3, -5], [0, 4, 2, 1], [2, -2, -1, 6], [-3, 2, -1, 5]], [[1, 4, -1, 1], [-1, 3, -1, 0], [1, 0, -2, 6], [3, 0, -2, 1], [4, 2, 1, -1]]]> : tensor<3x5x4xi16>
    %1 = stablehlo.constant dense<[[[-2, 0, -1, -2], [3, 1, 1, 1]], [[1, 3, -4, -1], [-2, -4, -2, 1]], [[2, -1, -2, 0], [6, -2, 1, -2]]]> : tensor<3x2x4xi16>
    return %0, %1 : tensor<3x5x4xi16>, tensor<3x2x4xi16>
  }
  func.func private @expected() -> tensor<3x5x4xi16> {
    %0 = stablehlo.constant dense<[[[1, 0, -8, 0], [0, 0, 3, -4], [0, 1, -2, 1], [-2, 1, -3, 1], [-1, -2, 0, -1]], [[0, 1, 3, -3], [0, 48, 24, 5], [0, 4, 2, 1], [2, -2, -1, 6], [-3, 2, -1, 5]], [[1, 4, -1, 1], [-12, 6, 2, 0], [1, 0, -2, 6], [3, 0, -2, 1], [4, 2, 1, -1]]]> : tensor<3x5x4xi16>
