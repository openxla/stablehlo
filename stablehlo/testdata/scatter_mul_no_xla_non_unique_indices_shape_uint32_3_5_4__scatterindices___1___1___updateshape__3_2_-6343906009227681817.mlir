...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3x5x4xui32>, tensor<3x2x4xui32>) {
    %0 = stablehlo.constant dense<[[[1, 2, 2, 3], [6, 0, 1, 2], [4, 3, 3, 0], [1, 0, 4, 5], [0, 0, 0, 1]], [[3, 4, 0, 0], [1, 2, 4, 4], [2, 0, 4, 1], [4, 2, 0, 0], [1, 0, 0, 0]], [[2, 4, 1, 0], [0, 4, 1, 2], [4, 3, 0, 0], [7, 0, 0, 4], [1, 4, 0, 1]]]> : tensor<3x5x4xui32>
    %1 = stablehlo.constant dense<[[[0, 1, 2, 0], [0, 1, 1, 1]], [[1, 3, 1, 2], [8, 1, 7, 1]], [[1, 2, 3, 4], [2, 4, 0, 3]]]> : tensor<3x2x4xui32>
    return %0, %1 : tensor<3x5x4xui32>, tensor<3x2x4xui32>
  }
  func.func private @expected() -> tensor<3x5x4xui32> {
    %0 = stablehlo.constant dense<[[[1, 2, 2, 3], [0, 0, 2, 0], [4, 3, 3, 0], [1, 0, 4, 5], [0, 0, 0, 1]], [[3, 4, 0, 0], [8, 6, 28, 8], [2, 0, 4, 1], [4, 2, 0, 0], [1, 0, 0, 0]], [[2, 4, 1, 0], [0, 32, 0, 24], [4, 3, 0, 0], [7, 0, 0, 4], [1, 4, 0, 1]]]> : tensor<3x5x4xui32>
