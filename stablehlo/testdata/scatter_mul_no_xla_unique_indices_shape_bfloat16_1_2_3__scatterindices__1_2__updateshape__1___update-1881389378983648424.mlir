...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xbf16>, tensor<1xbf16>) {
    %0 = stablehlo.constant dense<[[[2.500000e-01, 1.020510e-01, -2.296880e+00], [7.070310e-01, 2.468750e+00, -3.640630e+00]]]> : tensor<1x2x3xbf16>
    %1 = stablehlo.constant dense<-4.375000e+00> : tensor<1xbf16>
    return %0, %1 : tensor<1x2x3xbf16>, tensor<1xbf16>
  }
  func.func private @expected() -> tensor<1x2x3xbf16> {
    %0 = stablehlo.constant dense<[[[2.500000e-01, 1.020510e-01, -2.296880e+00], [7.070310e-01, 2.468750e+00, 1.593750e+01]]]> : tensor<1x2x3xbf16>
