...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1xf16>, tensor<f16>) {
    %0 = stablehlo.constant dense<2.789060e+00> : tensor<1xf16>
    %1 = stablehlo.constant dense<1.662600e-01> : tensor<f16>
    return %0, %1 : tensor<1xf16>, tensor<f16>
  }
  func.func private @expected() -> tensor<1xf16> {
    %0 = stablehlo.constant dense<4.636230e-01> : tensor<1xf16>
