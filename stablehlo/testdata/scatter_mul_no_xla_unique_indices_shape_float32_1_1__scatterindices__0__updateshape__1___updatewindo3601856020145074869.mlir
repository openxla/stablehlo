...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x1xf32>, tensor<1xf32>) {
    %0 = stablehlo.constant dense<-3.87760019> : tensor<1x1xf32>
    %1 = stablehlo.constant dense<-5.48736763> : tensor<1xf32>
    return %0, %1 : tensor<1x1xf32>, tensor<1xf32>
  }
  func.func private @expected() -> tensor<1x1xf32> {
    %0 = stablehlo.constant dense<21.2778187> : tensor<1x1xf32>
