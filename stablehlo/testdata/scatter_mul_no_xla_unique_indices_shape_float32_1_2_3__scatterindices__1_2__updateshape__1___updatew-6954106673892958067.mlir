...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xf32>, tensor<1xf32>) {
    %0 = stablehlo.constant dense<[[[2.46890092, 3.33910942, -2.56484985], [-0.872336804, 3.98790836, 0.109926455]]]> : tensor<1x2x3xf32>
    %1 = stablehlo.constant dense<-3.58542728> : tensor<1xf32>
    return %0, %1 : tensor<1x2x3xf32>, tensor<1xf32>
  }
  func.func private @expected() -> tensor<1x2x3xf32> {
    %0 = stablehlo.constant dense<[[[2.46890092, 3.33910942, -2.56484985], [-0.872336804, 3.98790836, -0.3941333]]]> : tensor<1x2x3xf32>
