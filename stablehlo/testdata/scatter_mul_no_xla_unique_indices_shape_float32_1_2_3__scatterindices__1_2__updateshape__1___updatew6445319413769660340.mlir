...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xf32>, tensor<1xf32>) {
    %0 = stablehlo.constant dense<[[[6.35700941, 0.194202542, -7.74557781], [-5.20988607, -4.41925859, 4.73127747]]]> : tensor<1x2x3xf32>
    %1 = stablehlo.constant dense<1.92537141> : tensor<1xf32>
    return %0, %1 : tensor<1x2x3xf32>, tensor<1xf32>
  }
  func.func private @expected() -> tensor<1x2x3xf32> {
    %0 = stablehlo.constant dense<[[[6.35700941, 0.194202542, -7.74557781], [-5.20988607, -4.41925859, 9.10946655]]]> : tensor<1x2x3xf32>
