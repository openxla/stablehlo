...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<4x2x3xi16>, tensor<2xi16>) {
    %0 = stablehlo.constant dense<[[[-1, -6, 2], [2, -4, -6]], [[0, 0, -1], [-2, -2, 1]], [[-2, 2, 4], [1, 0, 2]], [[0, 1, -2], [1, -3, -2]]]> : tensor<4x2x3xi16>
  ...
  func.func private @expected() -> tensor<4x2x3xi16> {
    %0 = stablehlo.constant dense<[[[-1, -6, 2], [2, -4, -6]], [[0, 0, -1], [-2, -2, 1]], [[-2, 2, 4], [1, 0, 2]], [[0, 1, 0], [1, -3, -8]]]> : tensor<4x2x3xi16>
