...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<4x2x3xi16>, tensor<2xi16>) {
    %0 = stablehlo.constant dense<[[[-10, 1, -2], [0, -1, 3]], [[0, 0, -6], [0, 1, -2]], [[0, 3, -1], [2, 0, 2]], [[3, 3, -2], [-2, -4, 2]]]> : tensor<4x2x3xi16>
  ...
  func.func private @expected() -> tensor<4x2x3xi16> {
    %0 = stablehlo.constant dense<[[[-10, 1, -2], [0, -1, 3]], [[0, 0, -6], [0, 1, -2]], [[0, 3, -1], [2, 0, 2]], [[3, 3, 4], [-2, -4, -6]]]> : tensor<4x2x3xi16>
