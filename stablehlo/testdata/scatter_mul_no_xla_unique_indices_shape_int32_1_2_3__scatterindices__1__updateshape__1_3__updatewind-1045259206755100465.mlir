...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xi32>, tensor<1x3xi32>) {
    %0 = stablehlo.constant dense<[[[-3, -3, 3], [-2, -3, -4]]]> : tensor<1x2x3xi32>
    %1 = stablehlo.constant dense<[[-3, 2, 1]]> : tensor<1x3xi32>
    return %0, %1 : tensor<1x2x3xi32>, tensor<1x3xi32>
  }
  func.func private @expected() -> tensor<1x2x3xi32> {
    %0 = stablehlo.constant dense<[[[-3, -3, 3], [6, -6, -4]]]> : tensor<1x2x3xi32>
