...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xui16>, tensor<2x3xui16>) {
    %0 = stablehlo.constant dense<[[[5, 2, 3], [1, 4, 2]]]> : tensor<1x2x3xui16>
    %1 = stablehlo.constant dense<[[6, 2, 0], [1, 3, 2]]> : tensor<2x3xui16>
    return %0, %1 : tensor<1x2x3xui16>, tensor<2x3xui16>
  }
  func.func private @expected() -> tensor<1x2x3xui16> {
    %0 = stablehlo.constant dense<[[[30, 4, 0], [1, 12, 4]]]> : tensor<1x2x3xui16>
