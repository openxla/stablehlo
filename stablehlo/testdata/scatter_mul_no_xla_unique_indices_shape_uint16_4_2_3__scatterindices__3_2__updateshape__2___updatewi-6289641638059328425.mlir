...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<4x2x3xui16>, tensor<2xui16>) {
    %0 = stablehlo.constant dense<[[[1, 0, 4], [0, 3, 0]], [[1, 1, 1], [2, 0, 1]], [[1, 2, 4], [2, 3, 1]], [[2, 4, 2], [0, 0, 4]]]> : tensor<4x2x3xui16>
    %1 = stablehlo.constant dense<[0, 1]> : tensor<2xui16>
    return %0, %1 : tensor<4x2x3xui16>, tensor<2xui16>
  }
  func.func private @expected() -> tensor<4x2x3xui16> {
    %0 = stablehlo.constant dense<[[[1, 0, 4], [0, 3, 0]], [[1, 1, 1], [2, 0, 1]], [[1, 2, 4], [2, 3, 1]], [[2, 4, 0], [0, 0, 4]]]> : tensor<4x2x3xui16>
