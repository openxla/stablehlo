...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<4x2x3xui16>, tensor<2xui16>) {
    %0 = stablehlo.constant dense<[[[2, 1, 1], [2, 6, 7]], [[3, 1, 4], [4, 4, 1]], [[3, 0, 0], [4, 3, 4]], [[1, 2, 1], [0, 0, 2]]]> : tensor<4x2x3xui16>
    %1 = stablehlo.constant dense<[0, 3]> : tensor<2xui16>
    return %0, %1 : tensor<4x2x3xui16>, tensor<2xui16>
  }
  func.func private @expected() -> tensor<4x2x3xui16> {
    %0 = stablehlo.constant dense<[[[2, 1, 1], [2, 6, 7]], [[3, 1, 4], [4, 4, 1]], [[3, 0, 0], [4, 3, 4]], [[1, 2, 0], [0, 0, 6]]]> : tensor<4x2x3xui16>
