...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xf32>, tensor<1xf32>) {
    %0 = stablehlo.constant dense<[[[-6.60815191, -2.80899096, -1.0238173], [-5.58544111, 0.253933668, 2.30542493]]]> : tensor<1x2x3xf32>
    %1 = stablehlo.constant dense<-7.86875438> : tensor<1xf32>
    return %0, %1 : tensor<1x2x3xf32>, tensor<1xf32>
  }
  func.func private @expected() -> tensor<1x2x3xf32> {
    %0 = stablehlo.constant dense<[[[-6.60815191, -2.80899096, -1.0238173], [-5.58544111, 0.253933668, -7.86875438]]]> : tensor<1x2x3xf32>
