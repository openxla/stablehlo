...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xf32>, tensor<1xf32>) {
    %0 = stablehlo.constant dense<[[[-0.0442725904, 1.03741574, 2.65727258], [-3.43177581, -6.11785507, 3.85477376]]]> : tensor<1x2x3xf32>
    %1 = stablehlo.constant dense<2.12194681> : tensor<1xf32>
    return %0, %1 : tensor<1x2x3xf32>, tensor<1xf32>
  }
  func.func private @expected() -> tensor<1x2x3xf32> {
    %0 = stablehlo.constant dense<[[[-0.0442725904, 1.03741574, 2.65727258], [-3.43177581, -6.11785507, 2.12194681]]]> : tensor<1x2x3xf32>
