...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xi16>, tensor<1x3xi16>) {
    %0 = stablehlo.constant dense<[[[-2, 3, -1], [-2, -2, -1]]]> : tensor<1x2x3xi16>
    %1 = stablehlo.constant dense<[[4, 5, 0]]> : tensor<1x3xi16>
    return %0, %1 : tensor<1x2x3xi16>, tensor<1x3xi16>
  }
  func.func private @expected() -> tensor<1x2x3xi16> {
    %0 = stablehlo.constant dense<[[[-2, 3, -1], [4, 5, 0]]]> : tensor<1x2x3xi16>
