...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<4x2x3xi16>, tensor<2xi16>) {
    %0 = stablehlo.constant dense<[[[0, 2, -1], [0, -1, -2]], [[1, -1, -3], [1, 4, -4]], [[-2, 2, -2], [-1, 0, 1]], [[8, -2, 0], [0, 2, 1]]]> : tensor<4x2x3xi16>
    %1 = stablehlo.constant dense<[-3, 4]> : tensor<2xi16>
    return %0, %1 : tensor<4x2x3xi16>, tensor<2xi16>
  }
  func.func private @expected() -> tensor<4x2x3xi16> {
    %0 = stablehlo.constant dense<[[[0, 2, -1], [0, -1, -2]], [[1, -1, -3], [1, 4, -4]], [[-2, 2, -2], [-1, 0, 1]], [[8, -2, -3], [0, 2, 4]]]> : tensor<4x2x3xi16>
