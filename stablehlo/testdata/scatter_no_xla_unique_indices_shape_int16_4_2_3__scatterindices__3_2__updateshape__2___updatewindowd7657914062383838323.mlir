...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<4x2x3xi16>, tensor<2xi16>) {
    %0 = stablehlo.constant dense<[[[0, -7, 0], [-1, -4, 3]], [[0, -9, -2], [-3, -1, -1]], [[6, 1, -2], [-5, 0, 2]], [[1, 0, 1], [0, 0, 1]]]> : tensor<4x2x3xi16>
  ...
  func.func private @expected() -> tensor<4x2x3xi16> {
    %0 = stablehlo.constant dense<[[[0, -7, 0], [-1, -4, 3]], [[0, -9, -2], [-3, -1, -1]], [[6, 1, -2], [-5, 0, 2]], [[1, 0, 0], [0, 0, 4]]]> : tensor<4x2x3xi16>
