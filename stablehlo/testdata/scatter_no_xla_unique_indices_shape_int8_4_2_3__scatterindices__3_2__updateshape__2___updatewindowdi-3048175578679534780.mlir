...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<4x2x3xi8>, tensor<2xi8>) {
    %0 = stablehlo.constant dense<[[[-1, 2, 0], [-4, -1, 0]], [[4, -2, -2], [0, -2, -3]], [[-5, 4, -3], [3, 3, 0]], [[0, 0, -1], [1, 1, 2]]]> : tensor<4x2x3xi8>
  ...
  func.func private @expected() -> tensor<4x2x3xi8> {
    %0 = stablehlo.constant dense<[[[-1, 2, 0], [-4, -1, 0]], [[4, -2, -2], [0, -2, -3]], [[-5, 4, -3], [3, 3, 0]], [[0, 0, -3], [1, 1, 1]]]> : tensor<4x2x3xi8>
