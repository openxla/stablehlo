...
module @jit_testcase {
  ...
  func.func private @inputs() -> tensor<8x9xi16> {
    %0 = stablehlo.constant dense<[[0, -1, -2, 0, 3, 0, 0, 1, 2], [0, 0, 3, -2, -2, 2, -4, 0, -1], [0, -1, 0, 5, 1, 1, 0, 0, 3], [3, 1, -2, 0, 1, 2, -4, -6, -3], [-3, -3, -1, 4, 3, -2, -1, 0, -2], [-4, 0, -5, 7, 0, 3, 4, 0, 1], [-3, 0, 0, -1, 1, 0, 1, -3, -1], [-1, 2, 4, 1, -4, 0, 0, 1, -1]]> : tensor<8x9xi16>
    return %0 : tensor<8x9xi16>
  }
  func.func private @expected() -> tensor<8x9xi16> {
    %0 = stablehlo.constant dense<[[0, -1, -2, 0, 3, 0, 0, 1, 2], [0, 0, 3, 0, 3, 2, 0, 1, 2], [0, 0, 3, 5, 3, 2, 0, 1, 3], [3, 1, 3, 5, 3, 2, 0, 1, 3], [3, 1, 3, 5, 3, 2, 0, 1, 3], [3, 1, 3, 7, 3, 3, 4, 1, 3], [3, 1, 3, 7, 3, 3, 4, 1, 3], [3, 2, 4, 7, 3, 3, 4, 1, 3]]> : tensor<8x9xi16>
    return %0 : tensor<8x9xi16>
  }
