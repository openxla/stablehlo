...
module @jit_testcase {
  ...
  func.func private @inputs() -> tensor<8x9xi16> {
    %0 = stablehlo.constant dense<[[-1, 3, -4, -3, 2, 0, 6, -2, 1], [-4, -4, -4, 0, 2, 3, 0, 3, 1], [-4, 0, 0, 3, -1, 1, 2, -1, -6], [-3, 1, -1, -4, 2, 0, 0, 3, 0], [-2, -5, -1, 1, -4, 5, 3, -1, 3], [0, -1, -1, -2, 5, 0, -2, 1, -2], [-2, 4, -8, 0, -4, 1, -3, -2, 4], [0, -2, 1, 1, 0, -1, 1, 1, 0]]> : tensor<8x9xi16>
    return %0 : tensor<8x9xi16>
  }
  func.func private @expected() -> tensor<8x9xi16> {
    %0 = stablehlo.constant dense<[[-1, 3, -4, -3, 2, 0, 6, -2, 1], [4, -12, 16, 0, 4, 0, 0, -6, 1], [-16, 0, 0, 0, -4, 0, 0, 6, -6], [48, 0, 0, 0, -8, 0, 0, 18, 0], [-96, 0, 0, 0, 32, 0, 0, -18, 0], [0, 0, 0, 0, 160, 0, 0, -18, 0], [0, 0, 0, 0, -640, 0, 0, 36, 0], [0, 0, 0, 0, 0, 0, 0, 36, 0]]> : tensor<8x9xi16>
    return %0 : tensor<8x9xi16>
  }
