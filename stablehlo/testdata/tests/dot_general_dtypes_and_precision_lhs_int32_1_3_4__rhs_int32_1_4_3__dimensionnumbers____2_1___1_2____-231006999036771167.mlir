...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x3x4xi32>, tensor<1x4x3xi32>) {
    %0 = stablehlo.constant dense<[[[3, 2, -1, -2], [-1, 0, 5, -7], [3, 0, 2, -4]]]> : tensor<1x3x4xi32>
    %1 = stablehlo.constant dense<[[[3, -2, -2], [3, -1, 0], [5, 1, 2], [0, 1, -2]]]> : tensor<1x4x3xi32>
    return %0, %1 : tensor<1x3x4xi32>, tensor<1x4x3xi32>
  }
  func.func private @expected() -> tensor<1xi32> {
    %0 = stablehlo.constant dense<16> : tensor<1xi32>
