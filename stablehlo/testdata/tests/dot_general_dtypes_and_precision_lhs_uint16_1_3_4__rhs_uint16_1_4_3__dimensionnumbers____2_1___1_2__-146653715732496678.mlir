...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x3x4xui16>, tensor<1x4x3xui16>) {
    %0 = stablehlo.constant dense<[[[0, 6, 3, 0], [0, 2, 1, 2], [0, 0, 0, 3]]]> : tensor<1x3x4xui16>
    %1 = stablehlo.constant dense<[[[9, 1, 1], [2, 0, 0], [1, 2, 3], [0, 0, 0]]]> : tensor<1x4x3xui16>
    return %0, %1 : tensor<1x3x4xui16>, tensor<1x4x3xui16>
  }
  func.func private @expected() -> tensor<1xui16> {
    %0 = stablehlo.constant dense<17> : tensor<1xui16>
