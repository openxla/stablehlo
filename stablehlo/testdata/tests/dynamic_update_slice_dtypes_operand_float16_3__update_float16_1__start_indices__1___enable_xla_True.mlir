...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %9 = stablehlo.dynamic_update_slice %0#0, %0#1, %8 : (tensor<3xf16>, tensor<1xf16>, tensor<i32>) -> tensor<3xf16>
    %10 = stablehlo.custom_call @check.eq(%9, %1) : (tensor<3xf16>, tensor<3xf16>) -> tensor<i1>
    return %10 : tensor<i1>
  }
  func.func private @inputs() -> (tensor<3xf16>, tensor<1xf16>, tensor<1xi32>) {
    %0 = stablehlo.constant dense<[-2.025390e+00, -4.904790e-01, 1.719730e+00]> : tensor<3xf16>
    %1 = stablehlo.constant dense<4.925780e+00> : tensor<1xf16>
    %2 = stablehlo.constant dense<1> : tensor<1xi32>
    return %0, %1, %2 : tensor<3xf16>, tensor<1xf16>, tensor<1xi32>
  }
  func.func private @expected() -> tensor<3xf16> {
    %0 = stablehlo.constant dense<[-2.025390e+00, 4.925780e+00, 1.719730e+00]> : tensor<3xf16>
