...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    %2 = "stablehlo.gather"(%0#0, %0#1) {dimension_numbers = #stablehlo.gather<offset_dims = [1], collapsed_slice_dims = [0], start_index_map = [0, 1], index_vector_dim = 1>, indices_are_sorted = false, slice_sizes = dense<[1, 5]> : tensor<2xi64>} : (tensor<3x10xf32>, tensor<3x2xi32>) -> tensor<3x5xf32>
