...
module @jit_testcase {
  ...
  func.func private @_take(%arg0: tensor<10xf16>, %arg1: tensor<i32>) -> tensor<f16> {
    ...
    %38 = "stablehlo.gather"(%arg0, %5) {dimension_numbers = #stablehlo.gather<collapsed_slice_dims = [0], start_index_map = [0]>, indices_are_sorted = false, slice_sizes = dense<1> : tensor<1xi64>} : (tensor<10xf16>, tensor<1xi32>) -> tensor<f16>
