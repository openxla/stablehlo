...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    }) {base_dilations = dense<1> : tensor<3xi64>, padding = dense<0> : tensor<3x2xi64>, window_dilations = dense<1> : tensor<3xi64>, window_dimensions = dense<[1, 2, 1]> : tensor<3xi64>, window_strides = dense<1> : tensor<3xi64>} : (tensor<1x2x1xf32>, tensor<f32>) -> tensor<1x1x1xf32>
