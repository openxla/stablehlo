...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xui16>, tensor<1x3xui16>) {
    %0 = stablehlo.constant dense<[[[2, 2, 2], [9, 0, 0]]]> : tensor<1x2x3xui16>
    %1 = stablehlo.constant dense<[[7, 5, 1]]> : tensor<1x3xui16>
    return %0, %1 : tensor<1x2x3xui16>, tensor<1x3xui16>
  }
  func.func private @expected() -> tensor<1x2x3xui16> {
    %0 = stablehlo.constant dense<[[[2, 2, 2], [16, 5, 1]]]> : tensor<1x2x3xui16>
