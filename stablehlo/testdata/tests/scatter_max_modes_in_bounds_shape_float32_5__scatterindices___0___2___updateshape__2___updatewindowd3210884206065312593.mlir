...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<5xf32>, tensor<2xf32>) {
    %0 = stablehlo.constant dense<[-3.75420856, -3.39852977, 0.531192064, 6.00137186, 2.613840e-01]> : tensor<5xf32>
    %1 = stablehlo.constant dense<[4.1338253, 3.6193037]> : tensor<2xf32>
    return %0, %1 : tensor<5xf32>, tensor<2xf32>
  }
  func.func private @expected() -> tensor<5xf32> {
    %0 = stablehlo.constant dense<[4.1338253, -3.39852977, 3.6193037, 6.00137186, 2.613840e-01]> : tensor<5xf32>
