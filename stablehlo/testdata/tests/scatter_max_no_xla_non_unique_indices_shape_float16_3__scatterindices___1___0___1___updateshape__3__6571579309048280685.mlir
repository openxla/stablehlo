...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<3xf16>, tensor<3xf16>) {
    %0 = stablehlo.constant dense<[-2.570310e+00, -1.203130e+00, 2.751950e+00]> : tensor<3xf16>
    %1 = stablehlo.constant dense<[1.551760e+00, -4.644530e+00, -3.708980e+00]> : tensor<3xf16>
    return %0, %1 : tensor<3xf16>, tensor<3xf16>
  }
  func.func private @expected() -> tensor<3xf16> {
    %0 = stablehlo.constant dense<[-2.570310e+00, 1.551760e+00, 2.751950e+00]> : tensor<3xf16>
