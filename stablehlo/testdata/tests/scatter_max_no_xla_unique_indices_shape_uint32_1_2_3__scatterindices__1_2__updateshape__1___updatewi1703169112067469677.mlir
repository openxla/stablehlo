...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xui32>, tensor<1xui32>) {
    %0 = stablehlo.constant dense<[[[1, 0, 3], [1, 2, 0]]]> : tensor<1x2x3xui32>
    %1 = stablehlo.constant dense<7> : tensor<1xui32>
    return %0, %1 : tensor<1x2x3xui32>, tensor<1xui32>
  }
  func.func private @expected() -> tensor<1x2x3xui32> {
    %0 = stablehlo.constant dense<[[[1, 0, 3], [1, 2, 7]]]> : tensor<1x2x3xui32>
