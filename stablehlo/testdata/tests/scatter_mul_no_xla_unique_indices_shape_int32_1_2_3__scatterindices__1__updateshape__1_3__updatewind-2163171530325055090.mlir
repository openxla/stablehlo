...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xi32>, tensor<1x3xi32>) {
    %0 = stablehlo.constant dense<[[[4, -4, 1], [0, 0, 3]]]> : tensor<1x2x3xi32>
    %1 = stablehlo.constant dense<[[-2, -2, -3]]> : tensor<1x3xi32>
    return %0, %1 : tensor<1x2x3xi32>, tensor<1x3xi32>
  }
  func.func private @expected() -> tensor<1x2x3xi32> {
    %0 = stablehlo.constant dense<[[[4, -4, 1], [0, 0, -9]]]> : tensor<1x2x3xi32>
