...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xi16>, tensor<1x3xi16>) {
    %0 = stablehlo.constant dense<[[[-5, 0, -3], [-1, -6, -2]]]> : tensor<1x2x3xi16>
    %1 = stablehlo.constant dense<[[-1, 1, 1]]> : tensor<1x3xi16>
    return %0, %1 : tensor<1x2x3xi16>, tensor<1x3xi16>
  }
  func.func private @expected() -> tensor<1x2x3xi16> {
    %0 = stablehlo.constant dense<[[[-5, 0, -3], [-1, 1, 1]]]> : tensor<1x2x3xi16>
