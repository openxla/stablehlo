...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<4x2x3xi32>, tensor<2xi32>) {
    %0 = stablehlo.constant dense<[[[0, 0, -6], [2, -1, 0]], [[2, 1, 0], [-2, 2, -5]], [[2, 0, 1], [1, 2, 4]], [[2, 2, -3], [-1, 0, 0]]]> : tensor<4x2x3xi32>
  ...
  func.func private @expected() -> tensor<4x2x3xi32> {
    %0 = stablehlo.constant dense<[[[0, 0, -6], [2, -1, 0]], [[2, 1, 0], [-2, 2, -5]], [[2, 0, 1], [1, 2, 4]], [[2, 2, 0], [-1, 0, -3]]]> : tensor<4x2x3xi32>
