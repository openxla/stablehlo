...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xui16>, tensor<2x3xui16>) {
    %0 = stablehlo.constant dense<[[[3, 1, 2], [6, 3, 2]]]> : tensor<1x2x3xui16>
    %1 = stablehlo.constant dense<[[0, 1, 0], [3, 2, 0]]> : tensor<2x3xui16>
    return %0, %1 : tensor<1x2x3xui16>, tensor<2x3xui16>
  }
  func.func private @expected() -> tensor<1x2x3xui16> {
    %0 = stablehlo.constant dense<[[[0, 1, 0], [3, 2, 0]]]> : tensor<1x2x3xui16>
