...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<1x2x3xui32>, tensor<1xui32>) {
    %0 = stablehlo.constant dense<[[[0, 2, 3], [3, 1, 3]]]> : tensor<1x2x3xui32>
    %1 = stablehlo.constant dense<0> : tensor<1xui32>
    return %0, %1 : tensor<1x2x3xui32>, tensor<1xui32>
  }
  func.func private @expected() -> tensor<1x2x3xui32> {
    %0 = stablehlo.constant dense<[[[0, 2, 3], [3, 1, 0]]]> : tensor<1x2x3xui32>
