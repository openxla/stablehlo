...
module @jit_testcase {
  ...
  func.func private @inputs() -> (tensor<4x2x3xui32>, tensor<2xui32>) {
    %0 = stablehlo.constant dense<[[[3, 1, 1], [0, 3, 0]], [[1, 5, 1], [0, 4, 0]], [[1, 3, 2], [3, 1, 0]], [[4, 0, 0], [2, 1, 2]]]> : tensor<4x2x3xui32>
  ...
  func.func private @expected() -> tensor<4x2x3xui32> {
    %0 = stablehlo.constant dense<[[[3, 1, 1], [0, 3, 0]], [[1, 5, 1], [0, 4, 0]], [[1, 3, 2], [3, 1, 0]], [[4, 0, 1], [2, 1, 4]]]> : tensor<4x2x3xui32>
