...
module @jit_testcase {
  func.func public @main() -> tensor<i1> {
    ...
    }) {padding = dense<0> : tensor<3x2xi64>, window_dimensions = dense<2> : tensor<3xi64>, window_strides = dense<1> : tensor<3xi64>} : (tensor<2x4x6xbf16>, tensor<1x3x5xbf16>, tensor<bf16>) -> tensor<2x4x6xbf16>
