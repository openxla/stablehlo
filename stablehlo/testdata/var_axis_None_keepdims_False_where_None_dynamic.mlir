...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32> {mhlo.sharding = ""}) -> tensor<f32> {
    ...
    %1 = call @_var(%arg0, %arg1, %0) : (tensor<i64>, tensor<?x8x4xf32>, tensor<i64>) -> tensor<f32>
    return %1 : tensor<f32>
  }
  func.func private @_var(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32>, %arg2: tensor<i64>) -> tensor<f32> {
    ...
    %13 = stablehlo.dynamic_broadcast_in_dim %7, %12, dims = [0, 1, 2] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<1x1x1xf32>, tensor<3xi32>) -> tensor<?x8x4xf32>
    ...
    %22 = stablehlo.divide %20, %21 : tensor<f32>
