...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32> {mhlo.sharding = ""}) -> tensor<4xf32> {
    ...
    %1 = call @_var(%arg0, %arg1, %0) : (tensor<i64>, tensor<?x8x4xf32>, tensor<i64>) -> tensor<4xf32>
    return %1 : tensor<4xf32>
  }
  func.func private @_var(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32>, %arg2: tensor<i64>) -> tensor<4xf32> {
    ...
    %3 = stablehlo.reduce(%arg1 init: %2) across dimensions = [0, 1] : (tensor<?x8x4xf32>, tensor<f32>) -> tensor<4xf32>
     reducer(%arg3: tensor<f32>, %arg4: tensor<f32>)  {
      %24 = stablehlo.add %arg3, %arg4 : tensor<f32>
    ...
    %21 = stablehlo.convert %18 : (tensor<i64>) -> tensor<f32>
    %22 = stablehlo.broadcast_in_dim %21, dims = [] : (tensor<f32>) -> tensor<4xf32>
    %23 = stablehlo.divide %20, %22 : tensor<4xf32>
    return %23 : tensor<4xf32>
  }
}
