...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32> {mhlo.sharding = ""}) -> tensor<1x1x4xf32> {
    ...
    %1 = call @_var(%arg0, %arg1, %0) : (tensor<i64>, tensor<?x8x4xf32>, tensor<i64>) -> tensor<1x1x4xf32>
    return %1 : tensor<1x1x4xf32>
  }
  func.func private @_var(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32>, %arg2: tensor<i64>) -> tensor<1x1x4xf32> {
    ...
    %13 = stablehlo.dynamic_broadcast_in_dim %7, %12, dims = [0, 1, 2] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<1x1x4xf32>, tensor<3xi32>) -> tensor<?x8x4xf32>
    %14 = stablehlo.subtract %arg1, %13 : tensor<?x8x4xf32>
    %15 = stablehlo.multiply %14, %14 : tensor<?x8x4xf32>
    %16 = stablehlo.constant dense<8> : tensor<i64>
    ...
    %20 = stablehlo.reduce(%15 init: %19) across dimensions = [0, 1] : (tensor<?x8x4xf32>, tensor<f32>) -> tensor<4xf32>
     reducer(%arg3: tensor<f32>, %arg4: tensor<f32>)  {
      %25 = stablehlo.add %arg3, %arg4 : tensor<f32>
      stablehlo.return %25 : tensor<f32>
    }
    %21 = stablehlo.broadcast_in_dim %20, dims = [2] : (tensor<4xf32>) -> tensor<1x1x4xf32>
    %22 = stablehlo.convert %18 : (tensor<i64>) -> tensor<f32>
    %23 = stablehlo.broadcast_in_dim %22, dims = [] : (tensor<f32>) -> tensor<1x1x4xf32>
    %24 = stablehlo.divide %21, %23 : tensor<1x1x4xf32>
    return %24 : tensor<1x1x4xf32>
  }
}
