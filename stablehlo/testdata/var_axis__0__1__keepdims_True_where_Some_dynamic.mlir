...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32> {mhlo.sharding = ""}, %arg2: tensor<?x8x4xi1> {mhlo.sharding = ""}) -> tensor<1x1x4xf32> {
    ...
    %1 = call @_var(%arg0, %arg1, %0, %arg2) : (tensor<i64>, tensor<?x8x4xf32>, tensor<i64>, tensor<?x8x4xi1>) -> tensor<1x1x4xf32>
    return %1 : tensor<1x1x4xf32>
  }
  func.func private @_var(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32>, %arg2: tensor<i64>, %arg3: tensor<?x8x4xi1>) -> tensor<1x1x4xf32> {
    ...
    %16 = stablehlo.dynamic_broadcast_in_dim %10, %15, dims = [0, 1, 2] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<1x1x4xf32>, tensor<3xi32>) -> tensor<?x8x4xf32>
    ...
    %23 = stablehlo.broadcast_in_dim %22, dims = [2] : (tensor<4xf32>) -> tensor<1x1x4xf32>
    %24 = stablehlo.convert %arg2 : (tensor<i64>) -> tensor<f32>
    %25 = stablehlo.broadcast_in_dim %24, dims = [] : (tensor<f32>) -> tensor<1x1x4xf32>
    %26 = stablehlo.subtract %23, %25 : tensor<1x1x4xf32>
    ...
    %30 = stablehlo.reduce(%28 init: %29) across dimensions = [0, 1] : (tensor<?x8x4xf32>, tensor<f32>) -> tensor<4xf32>
     reducer(%arg4: tensor<f32>, %arg5: tensor<f32>)  {
      %33 = stablehlo.add %arg4, %arg5 : tensor<f32>
      stablehlo.return %33 : tensor<f32>
    }
    %31 = stablehlo.broadcast_in_dim %30, dims = [2] : (tensor<4xf32>) -> tensor<1x1x4xf32>
    %32 = stablehlo.divide %31, %26 : tensor<1x1x4xf32>
    return %32 : tensor<1x1x4xf32>
  }
