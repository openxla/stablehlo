...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32> {mhlo.sharding = ""}) -> tensor<8x4xf32> {
    ...
    %1 = call @_var(%arg0, %arg1, %0) : (tensor<i64>, tensor<?x8x4xf32>, tensor<i64>) -> tensor<8x4xf32>
    return %1 : tensor<8x4xf32>
  }
  func.func private @_var(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32>, %arg2: tensor<i64>) -> tensor<8x4xf32> {
    ...
    %1 = stablehlo.reduce(%arg1 init: %0) across dimensions = [0] : (tensor<?x8x4xf32>, tensor<f32>) -> tensor<8x4xf32>
     reducer(%arg3: tensor<f32>, %arg4: tensor<f32>)  {
      %20 = stablehlo.add %arg3, %arg4 : tensor<f32>
    ...
    %11 = stablehlo.dynamic_broadcast_in_dim %5, %10, dims = [0, 1, 2] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<1x8x4xf32>, tensor<3xi32>) -> tensor<?x8x4xf32>
    ...
    %17 = stablehlo.convert %14 : (tensor<i64>) -> tensor<f32>
    %18 = stablehlo.broadcast_in_dim %17, dims = [] : (tensor<f32>) -> tensor<8x4xf32>
    %19 = stablehlo.divide %16, %18 : tensor<8x4xf32>
