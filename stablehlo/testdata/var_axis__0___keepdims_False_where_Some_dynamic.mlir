...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32> {mhlo.sharding = ""}, %arg2: tensor<?x8x4xi1> {mhlo.sharding = ""}) -> tensor<8x4xf32> {
    ...
    %1 = call @_var(%arg0, %arg1, %0, %arg2) : (tensor<i64>, tensor<?x8x4xf32>, tensor<i64>, tensor<?x8x4xi1>) -> tensor<8x4xf32>
    return %1 : tensor<8x4xf32>
  }
  func.func private @_var(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32>, %arg2: tensor<i64>, %arg3: tensor<?x8x4xi1>) -> tensor<8x4xf32> {
    ...
    %16 = stablehlo.dynamic_broadcast_in_dim %10, %15, dims = [0, 1, 2] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<1x8x4xf32>, tensor<3xi32>) -> tensor<?x8x4xf32>
    ...
    %24 = stablehlo.broadcast_in_dim %23, dims = [] : (tensor<f32>) -> tensor<8x4xf32>
    %25 = stablehlo.subtract %22, %24 : tensor<8x4xf32>
    ...
    %29 = stablehlo.reduce(%27 init: %28) across dimensions = [0] : (tensor<?x8x4xf32>, tensor<f32>) -> tensor<8x4xf32>
     reducer(%arg4: tensor<f32>, %arg5: tensor<f32>)  {
      %31 = stablehlo.add %arg4, %arg5 : tensor<f32>
      stablehlo.return %31 : tensor<f32>
    }
    %30 = stablehlo.divide %29, %25 : tensor<8x4xf32>
    return %30 : tensor<8x4xf32>
  }
