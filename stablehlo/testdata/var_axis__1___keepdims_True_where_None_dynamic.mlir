...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32> {mhlo.sharding = ""}) -> tensor<?x1x4xf32> {
    ...
    %1 = call @_var(%arg0, %arg1, %0) : (tensor<i64>, tensor<?x8x4xf32>, tensor<i64>) -> tensor<?x1x4xf32>
    return %1 : tensor<?x1x4xf32>
  }
  func.func private @_var(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32>, %arg2: tensor<i64>) -> tensor<?x1x4xf32> {
    ...
    %1 = stablehlo.reduce(%arg1 init: %0) across dimensions = [1] : (tensor<?x8x4xf32>, tensor<f32>) -> tensor<?x4xf32>
     reducer(%arg3: tensor<f32>, %arg4: tensor<f32>)  {
      %42 = stablehlo.add %arg3, %arg4 : tensor<f32>
      stablehlo.return %42 : tensor<f32>
    }
    ...
    %7 = stablehlo.dynamic_broadcast_in_dim %1, %6, dims = [0, 2] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<?x4xf32>, tensor<3xi32>) -> tensor<?x1x4xf32>
    ...
    %14 = stablehlo.dynamic_broadcast_in_dim %8, %13, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<f32>, tensor<3xi32>) -> tensor<?x1x4xf32>
    ...
    %21 = stablehlo.dynamic_broadcast_in_dim %15, %20, dims = [0, 1, 2] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<?x1x4xf32>, tensor<3xi32>) -> tensor<?x8x4xf32>
    ...
    %33 = stablehlo.dynamic_broadcast_in_dim %27, %32, dims = [0, 2] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<?x4xf32>, tensor<3xi32>) -> tensor<?x1x4xf32>
    %34 = stablehlo.convert %25 : (tensor<i64>) -> tensor<f32>
    %35 = stablehlo.convert %arg0 : (tensor<i64>) -> tensor<i32>
    %36 = stablehlo.reshape %35 : (tensor<i32>) -> tensor<1xi32>
    %37 = stablehlo.constant dense<1> : tensor<1xi32>
    %38 = stablehlo.constant dense<4> : tensor<1xi32>
    %39 = stablehlo.concatenate %36, %37, %38, dim = 0 : (tensor<1xi32>, tensor<1xi32>, tensor<1xi32>) -> tensor<3xi32>
    %40 = stablehlo.dynamic_broadcast_in_dim %34, %39, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<f32>, tensor<3xi32>) -> tensor<?x1x4xf32>
    %41 = stablehlo.divide %33, %40 : tensor<?x1x4xf32>
    return %41 : tensor<?x1x4xf32>
  }
}
