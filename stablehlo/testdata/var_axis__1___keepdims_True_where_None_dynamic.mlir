...
module @jit_fun_flat_jax {
  ...
  func.func private @_var(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32>, %arg2: tensor<i64>) -> tensor<?x1x4xf32> {
    ...
    %33 = stablehlo.dynamic_broadcast_in_dim %27, %32, dims = [0, 2] : (tensor<?x4xf32>, tensor<3xi32>) -> tensor<?x1x4xf32>
    ...
    %40 = stablehlo.dynamic_broadcast_in_dim %34, %39, dims = [] : (tensor<f32>, tensor<3xi32>) -> tensor<?x1x4xf32>
