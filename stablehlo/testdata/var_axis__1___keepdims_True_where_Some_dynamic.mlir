...
module @jit_fun_flat_jax {
  ...
  func.func private @_var(%arg0: tensor<i64>, %arg1: tensor<?x8x4xf32>, %arg2: tensor<i64>, %arg3: tensor<?x8x4xi1>) -> tensor<?x1x4xf32> {
    ...
    %9 = stablehlo.dynamic_broadcast_in_dim %3, %8, dims = [0, 2] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<?x4xf32>, tensor<3xi32>) -> tensor<?x1x4xf32>
    ...
    %19 = stablehlo.dynamic_broadcast_in_dim %13, %18, dims = [0, 2] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<?x4xf32>, tensor<3xi32>) -> tensor<?x1x4xf32>
    ...
    %26 = stablehlo.dynamic_broadcast_in_dim %20, %25, dims = [0, 1, 2] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<?x1x4xf32>, tensor<3xi32>) -> tensor<?x8x4xf32>
    ...
    %38 = stablehlo.dynamic_broadcast_in_dim %32, %37, dims = [0, 2] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<?x4xf32>, tensor<3xi32>) -> tensor<?x1x4xf32>
    ...
    %45 = stablehlo.dynamic_broadcast_in_dim %39, %44, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<f32>, tensor<3xi32>) -> tensor<?x1x4xf32>
    ...
    %56 = stablehlo.dynamic_broadcast_in_dim %50, %55, dims = [0, 2] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<?x4xf32>, tensor<3xi32>) -> tensor<?x1x4xf32>
