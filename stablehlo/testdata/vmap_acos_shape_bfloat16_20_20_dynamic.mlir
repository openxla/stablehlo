...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x20x20xbf16> {mhlo.sharding = ""}) -> tensor<?x20x20xbf16> {
    ...
    %6 = stablehlo.dynamic_broadcast_in_dim %0, %5, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<bf16>, tensor<3xi32>) -> tensor<?x20x20xbf16>
    ...
    %15 = stablehlo.dynamic_broadcast_in_dim %9, %14, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<bf16>, tensor<3xi32>) -> tensor<?x20x20xbf16>
    ...
    %24 = stablehlo.dynamic_broadcast_in_dim %18, %23, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<bf16>, tensor<3xi32>) -> tensor<?x20x20xbf16>
    ...
    %33 = stablehlo.dynamic_broadcast_in_dim %27, %32, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<bf16>, tensor<3xi32>) -> tensor<?x20x20xbf16>
    ...
    %41 = stablehlo.dynamic_broadcast_in_dim %35, %40, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<bf16>, tensor<3xi32>) -> tensor<?x20x20xbf16>
