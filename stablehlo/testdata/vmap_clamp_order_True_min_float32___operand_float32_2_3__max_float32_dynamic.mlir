...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?xf32> {mhlo.sharding = ""}, %arg2: tensor<?x2x3xf32> {mhlo.sharding = ""}, %arg3: tensor<?xf32> {mhlo.sharding = ""}) -> tensor<?x2x3xf32> {
    ...
    %5 = stablehlo.dynamic_broadcast_in_dim %arg1, %4, dims = [0] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<?xf32>, tensor<3xi32>) -> tensor<?x2x3xf32>
    ...
    %11 = stablehlo.dynamic_broadcast_in_dim %arg3, %10, dims = [0] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<?xf32>, tensor<3xi32>) -> tensor<?x2x3xf32>
