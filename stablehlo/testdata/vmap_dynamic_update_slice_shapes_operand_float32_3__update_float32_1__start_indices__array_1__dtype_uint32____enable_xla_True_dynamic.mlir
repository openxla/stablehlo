...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x3xf32> {mhlo.sharding = ""}, %arg2: tensor<?x1xf32> {mhlo.sharding = ""}, %arg3: tensor<?x1xui32> {mhlo.sharding = ""}) -> tensor<?x3xf32> {
    ...
    %17 = stablehlo.dynamic_broadcast_in_dim %14, %16, dims = [] : (tensor<ui32>, tensor<1xi32>) -> tensor<?xui32>
    ...
    %22 = stablehlo.dynamic_broadcast_in_dim %19, %21, dims = [] : (tensor<ui32>, tensor<1xi32>) -> tensor<?xui32>
    ...
    %29 = stablehlo.dynamic_broadcast_in_dim %24, %28, dims = [0] : (tensor<?xui32>, tensor<2xi32>) -> tensor<?x1xui32>
