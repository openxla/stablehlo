...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x2x3x3xf32> {mhlo.sharding = ""}, %arg2: tensor<?x2x3xi64> {mhlo.sharding = ""}) -> tensor<?x2x3x2xf32> {
    ...
    %7 = "stablehlo.gather"(%arg1, %6) {dimension_numbers = #stablehlo.gather<offset_dims = [2, 3], collapsed_slice_dims = [0, 1], start_index_map = [0, 1, 2, 3], index_vector_dim = 2>, indices_are_sorted = false, slice_sizes = dense<[1, 1, 3, 2]> : tensor<4xi64>} : (tensor<?x2x3x3xf32>, tensor<?x2x4xi64>) -> tensor<?x2x3x2xf32>
