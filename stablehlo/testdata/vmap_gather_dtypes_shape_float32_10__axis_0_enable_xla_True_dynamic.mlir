...
module @jit_fun_flat_jax {
  ...
  func.func private @_take(%arg0: tensor<i64>, %arg1: tensor<?x10xf32>, %arg2: tensor<?xi32>) -> tensor<?xf32> {
    ...
    %61 = stablehlo.dynamic_broadcast_in_dim %56, %60, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<i64>, tensor<2xi32>) -> tensor<?x2xi64>
    ...
    %68 = stablehlo.dynamic_broadcast_in_dim %63, %67, dims = [0, 1] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<1x2xi64>, tensor<2xi32>) -> tensor<?x2xi64>
    ...
    %77 = stablehlo.dynamic_broadcast_in_dim %74, %76, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<f32>, tensor<1xi32>) -> tensor<?xf32>
