...
module @jit_fun_flat_jax {
  ...
  func.func private @_take(%arg0: tensor<i64>, %arg1: tensor<?x10x10x10xf32>, %arg2: tensor<?xi32>) -> tensor<?x10x10xf32> {
    ...
    %3 = stablehlo.dynamic_broadcast_in_dim %0, %2, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<i32>, tensor<1xi32>) -> tensor<?xi32>
    ...
    %8 = stablehlo.dynamic_broadcast_in_dim %5, %7, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<i32>, tensor<1xi32>) -> tensor<?xi32>
    ...
    %15 = stablehlo.dynamic_broadcast_in_dim %10, %14, dims = [0] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<?xi32>, tensor<2xi32>) -> tensor<?x1xi32>
    ...
    %50 = stablehlo.constant dense<10> : tensor<i64>
    ...
    %69 = stablehlo.dynamic_broadcast_in_dim %64, %68, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<i64>, tensor<2xi32>) -> tensor<?x2xi64>
    ...
    %76 = stablehlo.dynamic_broadcast_in_dim %71, %75, dims = [0, 1] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<1x2xi64>, tensor<2xi32>) -> tensor<?x2xi64>
    ...
    %87 = stablehlo.dynamic_broadcast_in_dim %80, %86, dims = [0] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<?xi1>, tensor<3xi32>) -> tensor<?x10x10xi1>
    ...
    %94 = stablehlo.dynamic_broadcast_in_dim %88, %93, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<f32>, tensor<3xi32>) -> tensor<?x10x10xf32>
