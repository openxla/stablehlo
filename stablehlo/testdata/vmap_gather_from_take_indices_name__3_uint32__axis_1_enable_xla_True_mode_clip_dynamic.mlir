...
module @jit_fun_flat_jax {
  ...
  func.func private @_take(%arg0: tensor<i64>, %arg1: tensor<?x10x10x10xf32>, %arg2: tensor<?x2xui32>) -> tensor<?x10x2x10xf32> {
    ...
    %5 = stablehlo.dynamic_broadcast_in_dim %arg2, %4, dims = [0, 1] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<?x2xui32>, tensor<3xi32>) -> tensor<?x2x1xui32>
