...
module @jit_fun_flat_jax {
  ...
  func.func private @_take(%arg0: tensor<i64>, %arg1: tensor<?x10x10x10xf32>, %arg2: tensor<?x2xui32>) -> tensor<?x10x2x10xf32> {
    ...
    %13 = "stablehlo.gather"(%arg1, %12) {dimension_numbers = #stablehlo.gather<offset_dims = [1, 3], collapsed_slice_dims = [0, 2], start_index_map = [0, 2], index_vector_dim = 2>, indices_are_sorted = false, slice_sizes = dense<[1, 10, 1, 10]> : tensor<4xi64>} : (tensor<?x10x10x10xf32>, tensor<?x2x2xui32>) -> tensor<?x10x2x10xf32>
