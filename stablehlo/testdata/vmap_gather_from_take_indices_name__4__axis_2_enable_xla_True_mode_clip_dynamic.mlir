...
module @jit_fun_flat_jax {
  ...
  func.func private @_take(%arg0: tensor<i64>, %arg1: tensor<?x10x10x10xf32>, %arg2: tensor<?x2x2xi32>) -> tensor<?x10x10x2x2xf32> {
    ...
    %6 = stablehlo.dynamic_broadcast_in_dim %arg2, %5, dims = [0, 1, 2] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<?x2x2xi32>, tensor<4xi32>) -> tensor<?x2x2x1xi32>
