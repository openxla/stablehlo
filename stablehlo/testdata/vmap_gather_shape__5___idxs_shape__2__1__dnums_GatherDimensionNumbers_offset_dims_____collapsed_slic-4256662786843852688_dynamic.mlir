...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x5xf32> {mhlo.sharding = ""}, %arg2: tensor<?x2x1xi64> {mhlo.sharding = ""}) -> tensor<?x2xf32> {
    ...
    %7 = "stablehlo.gather"(%arg1, %6) {dimension_numbers = #stablehlo.gather<collapsed_slice_dims = [0, 1], start_index_map = [0, 1], index_vector_dim = 2>, indices_are_sorted = false, slice_sizes = dense<1> : tensor<2xi64>} : (tensor<?x5xf32>, tensor<?x2x2xi64>) -> tensor<?x2xf32>
