...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x20x20xbf16> {mhlo.sharding = ""}) -> tensor<?x20x20xbf16> {
    ...
    %8 = stablehlo.dynamic_broadcast_in_dim %2, %7, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<bf16>, tensor<3xi32>) -> tensor<?x20x20xbf16>
    ...
    %16 = stablehlo.dynamic_broadcast_in_dim %10, %15, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<bf16>, tensor<3xi32>) -> tensor<?x20x20xbf16>
