...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?xf32> {mhlo.sharding = ""}, %arg2: tensor<?x2x3xf32> {mhlo.sharding = ""}) -> tensor<?x2x3xi1> {
    ...
    %5 = stablehlo.dynamic_broadcast_in_dim %arg1, %4, dims = [0] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<?xf32>, tensor<3xi32>) -> tensor<?x1x1xf32>
    ...
    %11 = stablehlo.dynamic_broadcast_in_dim %5, %10, dims = [0, 1, 2] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<?x1x1xf32>, tensor<3xi32>) -> tensor<?x2x3xf32>
    %12 = stablehlo.compare  NE, %11, %arg2,  FLOAT : (tensor<?x2x3xf32>, tensor<?x2x3xf32>) -> tensor<?x2x3xi1>
