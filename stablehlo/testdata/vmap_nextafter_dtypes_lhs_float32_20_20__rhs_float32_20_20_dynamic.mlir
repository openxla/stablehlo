module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x20x20xf32> {mhlo.sharding = ""}, %arg2: tensor<?x20x20xf32> {mhlo.sharding = ""}) -> tensor<?x20x20xf32> {
    ...
    %9 = stablehlo.compare  NE, %arg1, %arg1,  NOTYPE : (tensor<?x20x20xf32>, tensor<?x20x20xf32>) -> tensor<?x20x20xi1>
    %10 = stablehlo.compare  NE, %arg2, %arg2,  NOTYPE : (tensor<?x20x20xf32>, tensor<?x20x20xf32>) -> tensor<?x20x20xi1>
    ...
    %27 = stablehlo.compare  EQ, %arg1, %arg2,  NOTYPE : (tensor<?x20x20xf32>, tensor<?x20x20xf32>) -> tensor<?x20x20xi1>
    ...
    %32 = stablehlo.compare  EQ, %25, %31,  NOTYPE : (tensor<?x20x20xi32>, tensor<?x20x20xi32>) -> tensor<?x20x20xi1>
    %33 = stablehlo.compare  EQ, %26, %31,  NOTYPE : (tensor<?x20x20xi32>, tensor<?x20x20xi32>) -> tensor<?x20x20xi1>
    ...
    %41 = stablehlo.compare  NE, %34, %35,  NOTYPE : (tensor<?x20x20xi32>, tensor<?x20x20xi32>) -> tensor<?x20x20xi1>
    %42 = stablehlo.compare  GT, %25, %26,  NOTYPE : (tensor<?x20x20xi32>, tensor<?x20x20xi32>) -> tensor<?x20x20xi1>
