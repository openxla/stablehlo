...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x4x1x6xf32> {mhlo.sharding = ""}, %arg2: tensor<?x4x5x6xf32> {mhlo.sharding = ""}) -> tensor<?x4x5x6xf32> {
    ...
    %6 = stablehlo.dynamic_broadcast_in_dim %arg1, %5, dims = [0, 1, 2, 3] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<?x4x1x6xf32>, tensor<4xi32>) -> tensor<?x4x5x6xf32>
