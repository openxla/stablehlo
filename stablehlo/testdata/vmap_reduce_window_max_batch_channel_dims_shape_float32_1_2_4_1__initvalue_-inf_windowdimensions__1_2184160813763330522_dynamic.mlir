...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x1x2x4x1xf32> {mhlo.sharding = ""}) -> tensor<?x1x1x3x1xf32> {
    ...
    }) {base_dilations = dense<1> : tensor<5xi64>, padding = dense<0> : tensor<5x2xi64>, window_dilations = dense<1> : tensor<5xi64>, window_dimensions = dense<[1, 1, 2, 2, 1]> : tensor<5xi64>, window_strides = dense<1> : tensor<5xi64>} : (tensor<?x1x2x4x1xf32>, tensor<f32>) -> tensor<?x1x1x3x1xf32>
