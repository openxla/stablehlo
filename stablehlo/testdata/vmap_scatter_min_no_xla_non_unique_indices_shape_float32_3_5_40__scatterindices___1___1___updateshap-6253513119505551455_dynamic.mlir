...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x3x5x40xf32> {mhlo.sharding = ""}, %arg2: tensor<?x3x5x2xf32> {mhlo.sharding = ""}) -> tensor<?x3x5x40xf32> {
    ...
    }) {indices_are_sorted = false, scatter_dimension_numbers = #stablehlo.scatter<update_window_dims = [0, 1, 2], inserted_window_dims = [3], scatter_dims_to_operand_dims = [3], index_vector_dim = 1>, unique_indices = false} : (tensor<?x3x5x40xf32>, tensor<2x1xi64>, tensor<?x3x5x2xf32>) -> tensor<?x3x5x40xf32>
