...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x2x3xf32> {mhlo.sharding = ""}, %arg2: tensor<?x2x1x3xf32> {mhlo.sharding = ""}) -> tensor<?x2x3xf32> {
    ...
    }) {indices_are_sorted = false, scatter_dimension_numbers = #stablehlo.scatter<update_window_dims = [0, 1], inserted_window_dims = [2], scatter_dims_to_operand_dims = [2], index_vector_dim = 2>, unique_indices = false} : (tensor<?x2x3xf32>, tensor<1x3x1xi64>, tensor<?x2x1x3xf32>) -> tensor<?x2x3xf32>
