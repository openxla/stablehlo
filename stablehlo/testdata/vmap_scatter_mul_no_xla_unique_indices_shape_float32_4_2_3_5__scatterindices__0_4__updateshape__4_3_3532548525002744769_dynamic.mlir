...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x4x2x3x5xf32> {mhlo.sharding = ""}, %arg2: tensor<?x4x3xf32> {mhlo.sharding = ""}) -> tensor<?x4x2x3x5xf32> {
    ...
    }) {indices_are_sorted = false, scatter_dimension_numbers = #stablehlo.scatter<update_window_dims = [0, 1, 2], inserted_window_dims = [2, 4], scatter_dims_to_operand_dims = [2, 4]>, unique_indices = true} : (tensor<?x4x2x3x5xf32>, tensor<2xi64>, tensor<?x4x3xf32>) -> tensor<?x4x2x3x5xf32>
