...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x5x6x7xf32> {mhlo.sharding = ""}, %arg2: tensor<?x2x7xf32> {mhlo.sharding = ""}) -> tensor<?x5x6x7xf32> {
    ...
    }) {indices_are_sorted = false, scatter_dimension_numbers = #stablehlo.scatter<update_window_dims = [0, 2], inserted_window_dims = [1, 2], scatter_dims_to_operand_dims = [1, 2], index_vector_dim = 1>, unique_indices = true} : (tensor<?x5x6x7xf32>, tensor<2x2xi64>, tensor<?x2x7xf32>) -> tensor<?x5x6x7xf32>
