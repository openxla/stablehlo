...
module @jit_fun_flat_jax {
  func.func public @main(%arg0: tensor<i64>, %arg1: tensor<?x20x20xui64> {mhlo.sharding = ""}) -> tensor<?x20x20xui64> {
    ...
    %6 = stablehlo.dynamic_broadcast_in_dim %0, %5, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<ui64>, tensor<3xi32>) -> tensor<?x20x20xui64>
    ...
    %14 = stablehlo.dynamic_broadcast_in_dim %8, %13, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<ui64>, tensor<3xi32>) -> tensor<?x20x20xui64>
    ...
    %21 = stablehlo.dynamic_broadcast_in_dim %15, %20, dims = [] {known_expanding_dimensions = dense<> : tensor<0xi64>, known_nonexpanding_dimensions = dense<> : tensor<0xi64>} : (tensor<ui64>, tensor<3xi32>) -> tensor<?x20x20xui64>
