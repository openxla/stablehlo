...
#ifndef STABLEHLO_TESTS_INTERPRETER_OPS
#define STABLEHLO_TESTS_INTERPRETER_OPS
...
#include "stablehlo/tests/InterpreterOps.h.inc"

#endif  // STABLEHLO_TESTS_INTERPRETER_OPS
