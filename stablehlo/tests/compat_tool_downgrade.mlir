...
// RUN: stablehlo-translate --compat --use-test-converter %s --target=38 | stablehlo-translate --compat --use-test-converter --target=40 | FileCheck %s

func.func private @test_upgrade(%arg0: tensor<2xi1>) -> tensor<2xi1> 
  // CHECK:      attributes {compat_version = 40 : i64}
