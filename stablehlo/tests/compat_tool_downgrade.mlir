// RUN: stablehlo-translate --compat --use-test-converter %s --target=40 | FileCheck %s
// RUN: stablehlo-translate --compat --use-test-converter %s | stablehlo-translate --compat --use-test-converter --target=40 | FileCheck %s
// RUN: stablehlo-translate --compat --use-test-converter --emit-bytecode %s | stablehlo-translate --compat --use-test-converter --target=40 | FileCheck %s
