...
// RUN: TARGET=0.3.0; stablehlo-opt %s.bc --vhlo-to-version='target=current' --vhlo-legalize-to-stablehlo -emit-bytecode | stablehlo-opt --stablehlo-legalize-to-vhlo --vhlo-to-version="target=$TARGET" --mlir-print-op-generic  | FileCheck %s
