...
// CHECK-LABEL: Evaluated results of function: max_op_test_si4
func.func @max_op_test_si4() -> tensor<5xi4> {
...
// CHECK-LABEL: Evaluated results of function: max_op_test_ui4
func.func @max_op_test_ui4() -> tensor<2xui4> {
...
// CHECK-LABEL: Evaluated results of function: max_op_test_si8
func.func @max_op_test_si8() -> tensor<5xi8> {
...
// CHECK-LABEL: Evaluated results of function: max_op_test_ui8
func.func @max_op_test_ui8() -> tensor<2xui8> {
...
// CHECK-LABEL: Evaluated results of function: max_op_test_si16
func.func @max_op_test_si16() -> tensor<5xi16> {
...
// CHECK-LABEL: Evaluated results of function: max_op_test_ui16
func.func @max_op_test_ui16() -> tensor<2xui16> {
...
// CHECK-LABEL: Evaluated results of function: max_op_test_si32
func.func @max_op_test_si32() -> tensor<5xi32> {
...
// CHECK-LABEL: Evaluated results of function: max_op_test_ui32
func.func @max_op_test_ui32() -> tensor<2xui32> {
...
// CHECK-LABEL: Evaluated results of function: max_op_test_si64
func.func @max_op_test_si64() -> tensor<5xi64> {
...
// CHECK-LABEL: Evaluated results of function: max_op_test_ui64
func.func @max_op_test_ui64() -> tensor<2xui64> {
...
// CHECK-LABEL: Evaluated results of function: max_op_test_i1
func.func @max_op_test_i1() -> tensor<4xi1> {
...
// CHECK-LABEL: Evaluated results of function: max_op_test_bf16
func.func @max_op_test_bf16() -> tensor<11xbf16> {
...
// CHECK-LABEL: Evaluated results of function: max_op_test_f16
func.func @max_op_test_f16() -> tensor<11xf16> {
...
// CHECK-LABEL: Evaluated results of function: max_op_test_f32
func.func @max_op_test_f32() -> tensor<11xf32> {
...
// CHECK-LABEL: Evaluated results of function: max_op_test_f64
func.func @max_op_test_f64() -> tensor<11xf64> {
