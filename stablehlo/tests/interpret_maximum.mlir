...
func.func @max_op_test_f8_e4m3_fnuz() {
  ...
  %2 = stablehlo.maximum %0, %1 : tensor<10xf8E4M3FNUZ>
  check.expect_almost_eq_const %2, dense<[0xFF, -1.0, -0.000976562, 0.0, 0.0, 0.000976562, 1.0, 0x80, 0x80, 0x80]> : tensor<10xf8E4M3FNUZ>
  func.return
}
...
func.func @max_op_test_f8_e5m2_fnuz() {
  ...
  %2 = stablehlo.maximum %0, %1 : tensor<10xf8E5M2FNUZ>
  check.expect_almost_eq_const %2, dense<[0xFF, -1.0, -7.629390e-06, 0.0, 0.0, 7.629390e-06, 1.0, 0x80, 0x80, 0x80]> : tensor<10xf8E5M2FNUZ>
  func.return
}
