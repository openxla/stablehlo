...
// CHECK-LABEL: Evaluated results of function: negate_op_test_si4
func.func @negate_op_test_si4() -> tensor<5xi4> {
  %0 = stablehlo.constant dense<[-8, -1, 0, 1, 7]> : tensor<5xi4>
  %1 = stablehlo.negate %0 : tensor<5xi4>
  func.return %1 : tensor<5xi4>
...
// CHECK-LABEL: Evaluated results of function: negate_op_test_ui4
func.func @negate_op_test_ui4() -> tensor<3xui4> {
...
// CHECK-LABEL: Evaluated results of function: negate_op_test_si8
func.func @negate_op_test_si8() -> tensor<5xi8> {
  %0 = stablehlo.constant dense<[-128, -9, 0, 8, 127]> : tensor<5xi8>
  %1 = stablehlo.negate %0 : tensor<5xi8>
  func.return %1 : tensor<5xi8>
...
// CHECK-LABEL: Evaluated results of function: negate_op_test_ui8
func.func @negate_op_test_ui8() -> tensor<3xui8> {
...
// CHECK-LABEL: Evaluated results of function: negate_op_test_si16
func.func @negate_op_test_si16() -> tensor<5xi16> {
  %0 = stablehlo.constant dense<[-32768, -129, 0, 128, 32767]> : tensor<5xi16>
  %1 = stablehlo.negate %0 : tensor<5xi16>
  func.return %1 : tensor<5xi16>
...
// CHECK-LABEL: Evaluated results of function: negate_op_test_ui16
func.func @negate_op_test_ui16() -> tensor<3xui16> {
  ...
  // CHECK-NEXT: 0 : ui16
  // CHECK-NEXT: 65280 : ui16
  // CHECK-NEXT: 1 : ui16
}

// -----

// CHECK-LABEL: Evaluated results of function: negate_op_test_si32
func.func @negate_op_test_si32() -> tensor<5xi32> {
...
// CHECK-LABEL: Evaluated results of function: negate_op_test_ui32
func.func @negate_op_test_ui32() -> tensor<3xui32> {
  ...
  // CHECK-NEXT: 0 : ui32
  // CHECK-NEXT: 4294901760 : ui32
  // CHECK-NEXT: 1 : ui32
}

// -----

// CHECK-LABEL: Evaluated results of function: negate_op_test_si64
func.func @negate_op_test_si64() -> tensor<5xi64> {
...
// CHECK-LABEL: Evaluated results of function: negate_op_test_ui64
func.func @negate_op_test_ui64() -> tensor<3xui64> {
  ...
  // CHECK-NEXT: 0 : ui64
  // CHECK-NEXT: 18446744069414584320 : ui64
  // CHECK-NEXT: 1 : ui64
}

// -----

// CHECK-LABEL: Evaluated results of function: negate_op_test_bf16
func.func @negate_op_test_bf16() -> tensor<11xbf16> {
...
// CHECK-LABEL: Evaluated results of function: negate_op_test_f16
func.func @negate_op_test_f16() -> tensor<11xf16> {
...
// CHECK-LABEL: Evaluated results of function: negate_op_test_f32
func.func @negate_op_test_f32() -> tensor<11xf32> {
...
// CHECK-LABEL: Evaluated results of function: negate_op_test_f64
func.func @negate_op_test_f64() -> tensor<11xf64> {
...
// CHECK-LABEL: Evaluated results of function: negate_op_test_c64
func.func @negate_op_test_c64() -> tensor<2xcomplex<f32>> {
...
// CHECK-LABEL: Evaluated results of function: negate_op_test_c128
func.func @negate_op_test_c128() -> tensor<2xcomplex<f64>> {
