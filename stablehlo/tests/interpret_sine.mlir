...
func.func @sine_op_test_f32() -> tensor<12xf32> {
  ...
  %1 = stablehlo.sine %0 : tensor<12xf32>
  func.return %1 : tensor<12xf32>
...
func.func @sine_op_test_f64() -> tensor<12xf64> {
  ...
  %1 = stablehlo.sine %0 : tensor<12xf64>
  func.return %1 : tensor<12xf64>
