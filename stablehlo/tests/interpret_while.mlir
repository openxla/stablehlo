...
func.func @while() {
  ...
  %results0, %results1 = stablehlo.while(%curr_i = %init_i, %curr_sum = %init_sum) : tensor<i64>, tensor<i64>
  cond {
    %cond = stablehlo.compare LT, %curr_i, %ten : (tensor<i64>, tensor<i64>) -> tensor<i1>
