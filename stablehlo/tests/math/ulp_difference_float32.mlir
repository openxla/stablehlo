...
module @ulp_difference_float32 {
  ...
  func.func private @actual_0() -> tensor<12xf32> {
    // [np.float32(-3.4028235e+38), np.float32(-1e+09), np.float32(-1.1754944e-38), np.float32(-1e-45), np.float32(0.0), np.float32(1e-45), np.float32(1.1754944e-38), np.float32(1.2), np.float32(1e+09), np.float32(inf), np.float32(-inf), np.float32(nan)]
  ...
  func.func private @actual_1() -> tensor<9xf32> {
    // [np.float32(-3.4028235e+38), np.float32(-1e+09), np.float32(-1.1754944e-38), np.float32(-1e-45), np.float32(0.0), np.float32(1e-45), np.float32(1.1754944e-38), np.float32(1.2), np.float32(1e+09)]
  ...
  func.func private @shifted_1() -> tensor<9xf32> {
    // [np.float32(-3.4028233e+38), np.float32(-9.9999994e+08), np.float32(-1.1754942e-38), np.float32(-0.0), np.float32(1e-45), np.float32(3e-45), np.float32(1.1754945e-38), np.float32(1.2000002), np.float32(1.00000006e+09)]
  ...
  func.func private @shifted_5() -> tensor<9xf32> {
    // [np.float32(-3.4028225e+38), np.float32(-9.999997e+08), np.float32(-1.1754937e-38), np.float32(6e-45), np.float32(7e-45), np.float32(8e-45), np.float32(1.175495e-38), np.float32(1.2000006), np.float32(1.0000003e+09)]
  ...
  func.func private @shifted_50() -> tensor<9xf32> {
    // [np.float32(-3.4028133e+38), np.float32(-9.999968e+08), np.float32(-1.1754873e-38), np.float32(6.9e-44), np.float32(7e-44), np.float32(7.1e-44), np.float32(1.1755014e-38), np.float32(1.200006), np.float32(1.0000032e+09)]
  ...
  func.func private @actual_nonfinite() -> tensor<5xf32> {
    // [np.float32(inf), np.float32(inf), np.float32(inf), np.float32(inf), np.float32(inf)]
  ...
  func.func private @shifted_nonfinite() -> tensor<5xf32> {
    // [np.float32(-inf), np.float32(nan), np.float32(0.0), np.float32(1.2), np.float32(3.4028235e+38)]
