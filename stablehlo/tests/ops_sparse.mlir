...
//       CHECK: %[[T:.*]] = stablehlo.transpose %[[A]], perm = [1, 0] : (tensor<100x100xf64, #{{.*}}>) -> tensor<100x100xf64, #{{.*}}>
//       CHECK: return %[[T]] : tensor<100x100xf64, #{{.*}}>
func.func @sparse_transpose(%arg0: tensor<100x100xf64, #CSR>)
                                -> tensor<100x100xf64, #DCSR> {
  %0 = stablehlo.transpose %arg0, perm = [1, 0] : (tensor<100x100xf64, #CSR>) -> tensor<100x100xf64, #DCSR>
