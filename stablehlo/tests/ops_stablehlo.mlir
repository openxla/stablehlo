...
func.func @while(%constant0: tensor<i32>, %input0: tensor<i32>, %input1: tensor<i32>) -> (tensor<i32>, tensor<i32>) {
  ...
  func.return %results0, %results1 : tensor<i32>, tensor<i32>
}

// -----

func.func @while_c1(%constant0: tensor<i32>, %input0: tensor<i32>, %input1: tensor<i32>) -> (tensor<i32>, tensor<i32>) {
  // expected-error@+1{{expect operands to be compatible with condition block arguments but got 'tensor<i32>', 'tensor<i32>' vs 'tensor<i64>', 'tensor<i64>'}}
  %results0, %results1 = "stablehlo.while"(%input0, %input1) ({
...
func.func @while_c1(%constant0: tensor<i32>, %input0: tensor<i32>, %input1: tensor<i32>) -> (tensor<i32>, tensor<i32>) {
  ...
  %results0, %results1 = "stablehlo.while"(%input0, %input1) ({
    ^bb0(%arg0: tensor<i32>, %arg1: tensor<i32>):
      ...
      "stablehlo.return"(%0, %0) : (tensor<i1>, tensor<i1>) -> ()
  }, {
    ^bb0(%arg0: tensor<i32>, %arg1: tensor<i32>):
      %0 = "stablehlo.add"(%arg0, %constant0) : (tensor<i32>, tensor<i32>) -> tensor<i32>
      "stablehlo.return"(%0, %arg1) : (tensor<i32>, tensor<i32>) -> ()
...
func.func @while_c1(%constant0: tensor<i32>, %input0: tensor<i32>, %input1: tensor<i32>) -> (tensor<i32>, tensor<i32>) {
  ...
  %results0, %results1 = "stablehlo.while"(%input0, %input1) ({
    ^bb0(%arg0: tensor<i32>, %arg1: tensor<i32>):
      ...
      %1 = "stablehlo.reshape"(%0) : (tensor<i1>) -> tensor<1xi1>
      "stablehlo.return"(%1) : (tensor<1xi1>) -> ()
  }, {
    ^bb0(%arg0: tensor<i32>, %arg1: tensor<i32>):
      %0 = "stablehlo.add"(%arg0, %constant0) : (tensor<i32>, tensor<i32>) -> tensor<i32>
      "stablehlo.return"(%0, %arg1) : (tensor<i32>, tensor<i32>) -> ()
...
func.func @while_c2(%constant0: tensor<i64>, %input0: tensor<i32>, %input1: tensor<i32>) -> (tensor<i32>, tensor<i32>) {
  // expected-error@+1{{expect operands to be compatible with body block arguments but got 'tensor<i32>', 'tensor<i32>' vs 'tensor<i64>', 'tensor<i64>'}}
  %results0, %results1 = "stablehlo.while"(%input0, %input1) ({
    ^bb0(%arg0: tensor<i32>, %arg1: tensor<i32>):
      %0 = "stablehlo.compare"(%arg0, %arg1) {
        comparison_direction = #stablehlo<comparison_direction LT>
    ...
    ^bb0(%arg0: tensor<i64>, %arg1: tensor<i64>):
      %0 = "stablehlo.add"(%arg0, %constant0) : (tensor<i64>, tensor<i64>) -> tensor<i64>
      "stablehlo.return"(%0, %arg1) : (tensor<i64>, tensor<i64>) -> ()
  }) : (tensor<i32>, tensor<i32>) -> (tensor<i32>, tensor<i32>)
  func.return %results0, %results1 : tensor<i32>, tensor<i32>
}
...
func.func @while_c2(%constant0: tensor<i64>, %input0: tensor<i32>, %input1: tensor<i32>) -> (tensor<i32>, tensor<i32>) {
  // expected-error@+1{{expect operands to be compatible with body block return types but got 'tensor<i32>', 'tensor<i32>' vs 'tensor<i32>', 'tensor<i64>'}}
  %results0, %results1 = "stablehlo.while"(%input0, %input1) ({
    ^bb0(%arg0: tensor<i32>, %arg1: tensor<i32>):
      %0 = "stablehlo.compare"(%arg0, %arg1) {
        comparison_direction = #stablehlo<comparison_direction LT>
    ...
    ^bb0(%arg0: tensor<i32>, %arg1: tensor<i32>):
      "stablehlo.return"(%arg0, %constant0) : (tensor<i32>, tensor<i64>) -> ()
  }) : (tensor<i32>, tensor<i32>) -> (tensor<i32>, tensor<i32>)
  func.return %results0, %results1 : tensor<i32>, tensor<i32>
}
