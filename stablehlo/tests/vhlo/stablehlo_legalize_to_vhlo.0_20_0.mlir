...
// CHECK-LABEL: "attr_symbol_ref"
func.func @attr_symbol_ref(%arg0: tensor<f32>) -> tensor<f32> {
  //               CHECK: "vhlo.composite_v1"(%arg0) <{
  //          CHECK-SAME:   composite_attributes = #vhlo.dict_v1<{#vhlo.string_v1<"attr1"> = #vhlo.symbolref_v1<"composite_target">}>
  ...
  %0 = "stablehlo.composite"(%arg0) {
    composite_attributes = { attr1 = @composite_target },
