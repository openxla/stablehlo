...
func.func @illegal_type_tensor_element(%arg0: !vhlo.tensor<4x16x!vhlo.f8E5M2>) -> () {
...
func.func @illegal_type_complex_element(%arg0: !vhlo.tensor<4x16x!vhlo.complex<!vhlo.f8E5M2>>) -> () {
  // expected-error @+1 {{failed to legalize operation 'vhlo.add' that was explicitly marked illegal}}
...
func.func @illegal_type_tuple_element(%arg0: !vhlo.tuple<!vhlo.tensor<!vhlo.f32>, !vhlo.tensor<!vhlo.f8E5M2>>) -> () {
