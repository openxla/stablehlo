...
vhlo.func @illegal_type_quantized_storage(%arg0: !vhlo.tensor<!vhlo.quant<!vhlo.f8E4M3FN:!vhlo.f32, 3.400000e+01:16, -128:127, 1>>) -> () {
...
vhlo.func @illegal_type_quantized_expressed(%arg0: !vhlo.tensor<!vhlo.quant<!vhlo.i8:!vhlo.f8E5M2, 3.400000e+01:16, -128:127, 1>>) -> () {
  // expected-error @+1 {{failed to legalize operation 'vhlo.uniform_dequantize' that was explicitly marked illegal}}
