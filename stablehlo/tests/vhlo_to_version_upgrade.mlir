...
func.func @all_to_all_to_v2(%arg0: !vhlo.wrapped<tensor<4x16x!vhlo.f32>>) -> !vhlo.wrapped<tensor<16x4x!vhlo.f32>> {
  // CHECK-NEXT: %0 = "vhlo.all_to_all_v2"(%arg0)
  %0 = "vhlo.all_to_all"(%arg0) {
    split_dimension = #vhlo.wrapped<1 : i64>,
    concat_dimension = #vhlo.wrapped<0 : i64>,
    split_count = #vhlo.wrapped<4 : i64>,
    replica_groups = #vhlo.wrapped<dense<[[0, 1, 2, 3]]> : tensor<1x4xi64>>
  } : (!vhlo.wrapped<tensor<4x16x!vhlo.f32>>) -> !vhlo.wrapped<tensor<16x4x!vhlo.f32>>
  func.return %0 : !vhlo.wrapped<tensor<16x4x!vhlo.f32>>
}
