...
vhlo.func @all_to_all_to_v2(%arg0: !vhlo.tensor<4x16x!vhlo.f32>) -> !vhlo.tensor<16x4x!vhlo.f32> {
...
vhlo.func @all_gather_to_v2(%arg0: !vhlo.tensor<16x8x!vhlo.f32>) -> !vhlo.tensor<16x16x!vhlo.f32> {
...
vhlo.func @custom_call_to_v2(%arg0: !vhlo.tensor<2x!vhlo.integer<i1>>) -> !vhlo.tensor<2x!vhlo.integer<i1>> {
  // CHECK-NEXT: %0 = "vhlo.custom_call_v2"(%arg0)
  %0 = "vhlo.custom_call"(%arg0) {
    backend_config = #vhlo.string<"">,
    call_target_name = #vhlo.string<"foo">
  } : (!vhlo.tensor<2x!vhlo.integer<i1>>) -> !vhlo.tensor<2x!vhlo.integer<i1>>
  vhlo.return %0 : !vhlo.tensor<2x!vhlo.integer<i1>>
}
