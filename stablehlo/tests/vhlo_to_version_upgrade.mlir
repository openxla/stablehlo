...
func.func @collective_permute_to_v2(%arg0: !vhlo.wrapped<tensor<16x8x!vhlo.f32>>) -> !vhlo.wrapped<tensor<16x8x!vhlo.f32>> {
  ...
  %0 = "vhlo.collective_permute"(%arg0) {source_target_pairs = dense<[[0, 1], [1, 2], [2, 3]]> : tensor<3x2xi64>} : (!vhlo.wrapped<tensor<16x8x!vhlo.f32>>) -> !vhlo.wrapped<tensor<16x8x!vhlo.f32>>
