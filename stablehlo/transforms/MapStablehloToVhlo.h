...
MAP_STABLEHLO_TO_VHLO(AsyncStartOp, V1)
MAP_STABLEHLO_TO_VHLO(AsyncDoneOp, V1)
...
MAP_STABLEHLO_TO_VHLO(CollectiveBroadcastOp, V2)
MAP_STABLEHLO_TO_VHLO(CollectiveReduceOp, V1)
